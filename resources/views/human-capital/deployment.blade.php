            ...
            <div class="border rounded-md h-full overflow-auto bg-white">
                <table class="w-full text-sm table-fixed border-collapse">
                    ...
                    <tbody class="bg-white">
                        <tr class="border-t"><td class="p-3">Assignment</td><td class="p-3">Employee assignment records</td><td class="p-3 text-gray-400">No data</td></tr>
                        <tr class="border-t"><td class="p-3">Deployment Order</td><td class="p-3">Formal deployment order documents</td><td class="p-3 text-gray-400">No data</td></tr>
                        <tr class="border-t"><td class="p-3">Location</td><td class="p-3">Deployment site / branch records</td><td class="p-3 text-gray-400">No data</td></tr>
                        <tr class="border-t"><td class="p-3">Reporting</td><td class="p-3">Deployment status and reporting</td><td class="p-3 text-gray-400">No data</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
