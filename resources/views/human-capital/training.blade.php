    ...
    <div class="bg-white rounded-xl border border-gray-200 flex flex-col flex-grow min-h-0">
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b shrink-0 gap-4">
            <div class="flex items-center flex-1 min-w-0">
                <h1 class="text-lg font-semibold text-gray-900">Training</h1>
            </div>
            ...
            <div class="border rounded-md h-full overflow-auto bg-white">
                <table class="w-full text-sm table-fixed border-collapse">
                    ...
                    <tbody class="bg-white">
                        <tr class="border-t"><td class="p-3">Training Records</td><td class="p-3">All employee training records</td><td class="p-3 text-gray-400">No data</td></tr>
                        <tr class="border-t"><td class="p-3">Certificates</td><td class="p-3">Employee-specific training certificates</td><td class="p-3 text-gray-400">No data</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
