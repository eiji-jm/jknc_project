            ...
            <div class="border rounded-md h-full overflow-auto bg-white">
                <table class="w-full text-sm table-fixed border-collapse">
                    ...
                    <tbody class="bg-white">
                        <tr class="border-t"><td class="p-3">Incident Report Form</td><td class="p-3">Employee incident reporting</td><td class="p-3 text-gray-400">No data</td></tr>
                        <tr class="border-t"><td class="p-3">Employee Grievance Form</td><td class="p-3">Employee concern and grievance filing</td><td class="p-3 text-gray-400">No data</td></tr>
                        <tr class="border-t"><td class="p-3">Mediation / Resolution Form</td><td class="p-3">Conflict mediation and resolution records</td><td class="p-3 text-gray-400">No data</td></tr>
                        <tr class="border-t"><td class="p-3">Memos</td><td class="p-3">Memos and communications for specific employees</td><td class="p-3 text-gray-400">No data</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
