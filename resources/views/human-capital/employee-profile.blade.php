            ...
            <div class="border rounded-md h-full overflow-auto bg-white">
                <table class="w-full text-sm table-fixed border-collapse">
                    ...
                    <tbody class="bg-white">
                        <tr class="border-t"><td class="p-3">Employee Master List</td><td class="p-3">Main list of all employees</td><td class="p-3 text-gray-400">No data</td></tr>
                        <tr class="border-t"><td class="p-3">Specific Employee Profile</td><td class="p-3">Detailed employee record and profile view</td><td class="p-3 text-gray-400">No data</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
