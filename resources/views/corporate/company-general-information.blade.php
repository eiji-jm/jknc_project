                    ...
                    <div class="mx-auto max-w-[980px] bg-white border border-gray-300">
                        ...
                        <div class="px-6 pt-6 text-center">
                            ...
                            <div class="text-[11px] font-semibold text-gray-900 mt-1">
                                FOR THE YEAR <span class="px-2 border-b border-gray-400">{{ now()->year }}</span>
                            </div>
                        ...
                        <div class="px-6 pb-6">
                            ...
                            <div class="grid grid-cols-12 gap-0">
                                <div class="col-span-8 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ $gis->corporation_name ?? '' }}" readonly>
                                </div>
                                <div class="col-span-4 gis-cell">
                                    <div class="px-2 pt-1 gis-label">DATE REGISTERED:</div>
                                    <input class="gis-input" value="{{ !empty($gis->date_registered) ? \Carbon\Carbon::parse($gis->date_registered)->format('F d, Y') : '' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-8 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ $gis->trade_name ?? '' }}" readonly>
                                </div>
                                <div class="col-span-4 gis-cell">
                                    <div class="px-2 pt-1 gis-label">FISCAL YEAR END:</div>
                                    <input class="gis-input" value="{{ $gis->fiscal_year_end ?? '' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-8 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ $gis->company_reg_no ?? '' }}" readonly>
                                </div>
                                <div class="col-span-4 gis-cell">
                                    <div class="px-2 pt-1 gis-label">CORPORATE TAX IDENTIFICATION NUMBER (TIN):</div>
                                    <input class="gis-input" value="{{ $gis->tin ?? '' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-8 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ $gis->meeting_type ?? '' }}" readonly>
                                </div>
                                <div class="col-span-4 gis-cell">
                                    <div class="px-2 pt-1 gis-label">WEBSITE/URL ADDRESS:</div>
                                    <input class="gis-input" value="{{ $gis->website ?? '' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-8 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ !empty($gis->annual_meeting) ? \Carbon\Carbon::parse($gis->annual_meeting)->format('F d, Y') : '' }}" readonly>
                                </div>
                                <div class="col-span-4 gis-cell">
                                    <div class="px-2 pt-1 gis-label">E-MAIL ADDRESS:</div>
                                    <input class="gis-input" value="{{ $gis->email ?? '' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-8 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ $gis->principal_address ?? '' }}" readonly>
                                </div>
                                <div class="col-span-4 gis-cell">
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-12 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ $gis->business_address ?? '' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                ...
                                <div class="col-span-3 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ $gis->official_mobile ?? '' }}" readonly>
                                </div>
                                <div class="col-span-3 gis-cell">
                                    <div class="px-2 pt-1 gis-label">ALTERNATE MOBILE NUMBER</div>
                                    <input class="gis-input" value="{{ $gis->alternate_mobile ?? '' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-6 gis-cell">
                                    ...
                                    <input class="gis-input" value="{{ $gis->auditor ?? '' }}" readonly>
                                </div>
                                <div class="col-span-3 gis-cell">
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-6 gis-cell">
                                    ...
                                    <textarea class="gis-input" rows="4" readonly>{{ $gis->industry ?? '' }}</textarea>
                                </div>
                                <div class="col-span-3 gis-cell">
                                    <div class="px-2 pt-1 gis-label">INDUSTRY CLASSIFICATION:</div>
                                    <input class="gis-input" value="{{ $gis->industry ?? '' }}" readonly>
                                </div>
                                <div class="col-span-3 gis-cell">
                                    <div class="px-2 pt-1 gis-label">GEOGRAPHICAL CODE:</div>
                                    <input class="gis-input" value="{{ $gis->geo_code ?? '' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-4 gis-cell"><input class="gis-input text-center" value="{{ $gis->parent_company_name ?: 'N/A' }}" readonly></div>
                                <div class="col-span-4 gis-cell"><input class="gis-input text-center" value="{{ $gis->parent_company_sec_no ?: 'N/A' }}" readonly></div>
                                <div class="col-span-4 gis-cell"><input class="gis-input text-center" value="{{ $gis->parent_company_address ?: 'N/A' }}" readonly></div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-0 -mt-px">
                                <div class="col-span-4 gis-cell"><input class="gis-input text-center" value="{{ $gis->subsidiary_name ?: 'N/A' }}" readonly></div>
                                <div class="col-span-4 gis-cell"><input class="gis-input text-center" value="{{ $gis->subsidiary_sec_no ?: 'N/A' }}" readonly></div>
                                <div class="col-span-4 gis-cell"><input class="gis-input text-center" value="{{ $gis->subsidiary_address ?: 'N/A' }}" readonly></div>
                            </div>
