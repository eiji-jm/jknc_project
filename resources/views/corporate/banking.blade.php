            ...
            <div class="border rounded-md overflow-hidden">
                <table class="w-full text-[13px] text-left">
                    <thead class="bg-gray-50 text-gray-500 border-b">
                        <tr>
                            <th class="p-3 font-semibold border-r w-1/8">Date Uploaded</th>
                            <th class="p-3 font-semibold border-r w-1/8">Uploaded By:</th>
                            <th class="p-3 font-semibold border-r w-1/8">Client</th>
                            <th class="p-3 font-semibold border-r w-1/8">TIN</th>
                            <th class="p-3 font-semibold border-r w-1/8">Banks</th>
                            <th class="p-3 font-semibold border-r w-1/8">Bank Docs</th>
                            <th class="p-3 font-semibold w-1/8">Status</th>
                        </tr>
                    </thead>
