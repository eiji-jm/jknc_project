                            ...
                            <div x-show="activeDraftPane === 'live'">
                                <div class="mx-auto max-w-[860px] rounded-sm bg-white px-14 py-12 shadow-[0_18px_50px_rgba(15,23,42,0.08)] text-[13px] leading-7 text-gray-900 min-h-[920px]" style="font-family: Georgia, 'Times New Roman', serif;">
                                    ...
                                    <div class="mt-8 space-y-4 text-justify">
                                        <p>I, <strong data-preview="certificate-secretary">{{ $certificate->secretary ?: $defaultSecretary }}</strong>, of legal age, single, Filipino and with residence at <strong>PEARL ST. STA. TERESITA VILL. TISA, CEBU CITY</strong>, depose under oath and hereby state:</p>
                                        ...
                                        <div class="my-6 text-center font-bold uppercase" data-preview="certificate-resolution-title">{{ $certificate->resolution_no ? 'BOARD RESOLUTION NO. ' . $certificate->resolution_no : 'CERTIFIED MINUTES EXTRACT' }}</div>
                                        <p><strong data-preview="certificate-purpose">{{ $certificate->purpose ?: 'Corporate Purpose' }}</strong></p>
                                        ...
                                        <p>WITNESS MY HAND this ________ of ___________, <span data-preview="certificate-issued-year">{{ optional($certificate->date_issued)->format('Y') ?: now()->year }}</span> at Cebu City, Cebu, Philippines.</p>
                                    </div>
                                    ...
                                    <div class="mt-10 text-[12px] leading-6">
                                        <p>SUBSCRIBED AND SWORN to before me on the date and place above-mentioned, affiant exhibiting his/her TIN issued on <strong data-preview="certificate-issued-date">{{ $issuedDate }}</strong>, at Cebu City, Philippines.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div class="col-span-2">
                            <div class="overflow-hidden rounded-xl border border-gray-300 bg-white">
                                ...
                                <div id="certificate-body-editor" contenteditable="true" data-placeholder="Write the certified body here..." class="secretary-rich-editor min-h-[360px] p-4 text-sm leading-7 text-gray-900 outline-none">{!! $certificateBody !!}</div>
