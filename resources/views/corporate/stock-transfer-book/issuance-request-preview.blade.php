            ...
            <div class="space-y-4">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Existing COS/CV In Certificates</span><div class="font-medium text-gray-900">{{ $requestRecord->certificate?->certificate_type ?: '-' }} {{ $requestRecord->certificate?->stock_number ?: '' }}</div></div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Notes</span><div class="font-medium text-gray-900">{{ $requestRecord->notes ?: '-' }}</div></div>
                    </div>
                </div>
