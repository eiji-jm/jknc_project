                ...
                <div class="certificate">
                    ...
                    <div class="content">
                        <div class="left-column">
                            ...
                            <div class="body-copy">
                                <span class="fill">{{ $shareholder }}</span>
                                is the owner of
                                <span class="fill">{{ $shareCount }}</span>
                                shares of the Capital Stock of
                                <span class="fill">{{ $corporation }}</span>
                            ...
                            <div class="witness">
                                ...
                                <span class="fill">{{ $issueDay }}</span>
                                day of
                                <span class="fill">{{ $issueMonthYear }}</span>.
                            </div>
                        ...
                        <div class="side-column">
                            <div class="side-panel">
                                <div class="body-copy" style="font-size:12px; line-height:1.7; text-align:left;">
                                    Certificate No.
                                    <span class="fill" style="min-width:22mm;">{{ $certificateNo }}</span><br>
                                    Par Value
                                    <span class="fill" style="min-width:20mm;">{{ $parValue }}</span><br>
                                    Amount
                                    <span class="fill" style="min-width:28mm;">{{ $amountWords }}</span>
                                </div>
                            </div>

                            <div class="signatures">
                                <div class="signature">
                                    <div class="signature-line">{{ $certificate->president ?? '-' }}</div>
                                    <div class="signature-role">President</div>
                                </div>
                                <div class="signature">
                                    <div class="signature-line">{{ $certificate->corporate_secretary ?? '-' }}</div>
                    ...
                    <div class="footer-row">
                        <div class="bottom-plate text-wrap">{{ $amountWords }}</div>
                        <div class="bottom-plate">{{ $parValue }}</div>
