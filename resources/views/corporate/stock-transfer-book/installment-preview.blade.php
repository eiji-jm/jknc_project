...
@php
    $blankRows = 26;
    $paymentStatus = strtolower((string) ($installment->payment_status ?? 'pending'));
    ...
    $paymentRows = collect($relatedJournals ?? [])
                                    ...
                                    <table class="w-full text-[10px]">
                                        ...
                                        <tbody>
                                            <tr class="border-b border-gray-300">
                                                ...
                                                <td class="border-r border-gray-300 px-2 py-2">{{ $installment->total_value ?? '' }}</td>
                                                <td class="border-r border-gray-300 px-2 py-2"></td>
                                                <td class="border-r border-gray-300 px-2 py-2"></td>
                                                <td class="border-r border-gray-300 px-2 py-2"></td>
                                                <td class="px-2 py-2"></td>
                                            </tr>
                                            @foreach ($paymentRows as $index => $paymentJournal)
                                                <tr class="border-b border-gray-300">
                                                    <td class="border-r border-gray-300 px-2 py-2">&nbsp;</td>
                                                    <td class="border-r border-gray-300 px-2 py-2"></td>
                                                    <td class="border-r border-gray-300 px-2 py-2"></td>
                                                    <td class="border-r border-gray-300 px-2 py-2"></td>
                                                    <td class="border-r border-gray-300 px-2 py-2">{{ optional($paymentJournal->entry_date)->format('m/d/Y') ?? '' }}</td>
                                                    <td class="border-r border-gray-300 px-2 py-2">{{ optional($paymentJournal->entry_date)->format('m/d/Y') ?? '' }}</td>
                                                    <td class="border-r border-gray-300 px-2 py-2">{{ $index + 1 }}</td>
                                                    <td class="px-2 py-2">{{ $paymentJournal->no_shares ?? '' }}</td>
                                                </tr>
                                            @endforeach
