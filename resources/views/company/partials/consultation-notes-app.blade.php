...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = @json(route('company.consultation-notes.store', $company->id));
    const updateTemplate = @json(route('company.consultation-notes.update', [$company->id, '__NOTE__']));
    const deleteTemplate = @json(route('company.consultation-notes.destroy', [$company->id, '__NOTE__']));
    const defaultAuthor = @json($company->owner_name ?: 'John Admin');
    let notes = @json($consultationNotes);
    let editNoteId = null;
