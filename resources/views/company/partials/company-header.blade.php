...
<x-slide-over id="editCompanyModal" width="sm:max-w-[640px] lg:max-w-[760px]">
    ...
    <form id="editCompanyForm" method="POST" action="{{ route('company.update', $company->id) }}" class="flex min-h-0 flex-1 flex-col">
        @csrf
        @method('PUT')
