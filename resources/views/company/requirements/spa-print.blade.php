...
<div class="print-shell">
    ...
    <div class="document-page spa-document rounded-[24px] px-10 py-12">
        ...
        <div class="mt-8 space-y-5 text-justify">
            <p>
                I,
                <span class="spa-line spa-line-lg">{{ $spaData['principal_name'] }}</span>,
                {{ $spaData['nationality_label'] }}, of legal age, and resident of
                <span class="spa-line spa-line-lg">{{ $spaData['principal_address'] }}</span>,
                acting for and on behalf of
                <span class="spa-line spa-line-lg">{{ $spaData['business_name'] ?: '____________________________' }}</span>,
                do hereby name, constitute, and appoint
                <span class="spa-line">{{ $spaData['attorney_name'] }}</span>
                @if (filled($spaData['attorney_position']))
                    , {{ $spaData['attorney_position'] }}
                @endif
                , of legal age, {{ $spaData['nationality_label'] }} and resident of
                <span class="spa-line spa-line-lg">{{ $spaData['attorney_address'] }}</span>,
            ...
            <p>
                ...
                <span class="spa-line">{{ $spaData['signed_place'] }}</span>,
                Philippines, on this
                <span class="spa-line">{{ $spaData['signed_day'] }}</span>
                day of
                <span class="spa-line">{{ $spaData['signed_month'] }}</span>,
                <span class="spa-line">{{ $spaData['signed_year'] }}</span>.
            </p>
        </div>
        ...
        <div class="mt-14 grid gap-12 md:grid-cols-2">
            <div class="space-y-3">
                ...
                <div class="spa-sign-line">
                    <div class="font-semibold uppercase">{{ $spaData['principal_name'] }}</div>
            ...
            <div class="space-y-3">
                ...
                <div class="h-12"></div>
                <div class="spa-sign-line">
                    <div class="font-semibold uppercase">{{ $spaData['attorney_name'] }}</div>
        ...
        <div class="mt-16 space-y-5 border-t border-gray-300 pt-10">
            ...
            <div class="space-y-3 text-justify text-[13px]">
                ...
                <p>
                    ...
                    20<span class="spa-line">{{ $spaData['acknowledgement_year_short'] }}</span>,
            ...
            <div class="mt-10 grid gap-8 md:grid-cols-[1fr_280px]">
                <div class="space-y-2 text-[13px]">
                    ...
                    <p>Page No. _______;</p>
                    <p>Book No. _______;</p>
                    <p>Series of 20{{ $spaData['acknowledgement_year_short'] }}.</p>
                </div>
                <div class="pt-8">
                    <div class="spa-sign-line">
