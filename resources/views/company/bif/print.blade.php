    ...
    <div class="print-shell mx-auto max-w-7xl p-6">
        <div class="no-print mb-4 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3">
            ...
            <div class="flex gap-2">
                <a href="{{ route('company.bif.show', ['company' => $company->id, 'bif' => $bif->id]) }}" class="inline-flex h-10 items-center rounded-full border border-gray-200 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50">
                    Back
                </a>
        ...
        @include('company.bif.partials.document', ['wrapperClass' => 'bif-doc document-page'])
    </div>
