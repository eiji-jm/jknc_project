<div id="createProductModal" class="fixed inset-0 z-[60] hidden">
    <div class="absolute inset-0 bg-black/25"></div>
    <div class="relative mx-auto mt-20 w-full max-w-2xl rounded-2xl border border-gray-200 bg-white shadow-xl">
        ...
        <form method="POST" action="{{ route('products.store') }}" class="p-6">
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <div class="relative">
                    ...
                    <div id="productOwnerDropdownMenu" class="absolute right-0 z-20 mt-2 hidden w-72 rounded-xl border border-gray-200 bg-white p-2 shadow-lg">
