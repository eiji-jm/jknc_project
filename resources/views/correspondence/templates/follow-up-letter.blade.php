...
<body>
    <div class="page">
        ...
        <p>
            ...
            {{ $correspondence->details ?? 'the previous correspondence on this matter' }}.
        </p>

        <p>
            We would appreciate your response
            {{ $correspondence->deadline ? 'on or before ' . \Carbon\Carbon::parse($correspondence->deadline)->format('F d, Y') : 'at your earliest convenience' }}.
        </p>
