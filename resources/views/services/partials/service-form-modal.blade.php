...
<div id="{{ $modalId }}" class="fixed inset-0 z-[60] hidden bg-black/35 p-4 sm:p-6">
    <div class="mx-auto mt-6 w-full max-w-4xl rounded-xl border border-gray-200 bg-white overflow-hidden">
        ...
        <form id="{{ $formId }}" method="POST" action="{{ $action }}" class="max-h-[75vh] overflow-y-auto px-4 py-4">
            @csrf
