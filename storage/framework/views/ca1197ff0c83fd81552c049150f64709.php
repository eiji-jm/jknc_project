...
<body class="bg-[#eef4ff] text-slate-900">
    <div class="min-h-screen py-8">
        <div class="mx-auto max-w-6xl px-4">
            ...
            <form method="POST" action="<?php echo e($clientFormAction); ?>" enctype="multipart/form-data" class="space-y-4 border-x border-b border-slate-300 bg-white px-4 py-5 md:px-6">
                <?php echo csrf_field(); ?>
                ...
                <section class="border border-slate-300 bg-white p-5">
                    ...
                    <?php if(!empty($specimenRequirement['files'])): ?>
                        <p class="mt-3 text-xs text-slate-500"><?php echo e(count($specimenRequirement['files'])); ?> signed specimen file(s) currently uploaded.</p>
                    <?php endif; ?>
                </section>
...
<?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\contacts\specimen-client-form.blade.php ENDPATH**/ ?>