    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="bg-white border rounded-lg p-6 space-y-4">
            ...
            <div class="flex justify-between gap-4">
                ...
                <span class="text-right"><?php echo e($record->aoi_date); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">Regular ASM</span>
                <span class="text-right"><?php echo e($record->regular_asm); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">ASM Notice</span>
                <span class="text-right"><?php echo e($record->asm_notice); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">Regular BODM</span>
                <span class="text-right"><?php echo e($record->regular_bodm); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">BODM Notice</span>
                <span class="text-right"><?php echo e($record->bodm_notice); ?></span>
            </div>
            ...
            <div class="pt-4 border-t border-gray-100">
                ...
                <?php if($canEditRecord): ?>
                    <form x-show="editDraft || !<?php echo e($draftUrl ? 'true' : 'false'); ?>" x-cloak
                          action="<?php echo e(route('corporate.bylaws.upload.draft', $record->id)); ?>"
                          method="POST"
            ...
            <div class="pt-4 border-t border-gray-100">
                ...
                <?php if($canEditRecord): ?>
                    <form x-show="editNotary || !<?php echo e($notaryUrl ? 'true' : 'false'); ?>" x-cloak
                          action="<?php echo e(route('corporate.bylaws.upload.notary', $record->id)); ?>"
                          method="POST"
                          enctype="multipart/form-data"
                          class="space-y-3">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\bylaws-preview.blade.php ENDPATH**/ ?>