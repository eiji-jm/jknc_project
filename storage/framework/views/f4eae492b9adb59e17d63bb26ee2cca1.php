            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 bg-white">
                <div class="flex flex-wrap items-start justify-between gap-3 border-b border-gray-100 px-4 py-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Fill out the business client information details for <?php echo e($company->company_name); ?>.</p>
                    </div>
                ...
                <form method="POST" action="<?php echo e(route('company.bif.store', $company->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="bg-gray-50 p-4 sm:p-6">
                        <div class="mx-auto max-w-[1120px]">
                            <?php echo $__env->make('company.bif.partials.form-fields', ['bif' => null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>

                    <div class="flex flex-wrap items-center justify-end gap-2 border-t border-gray-100 px-4 py-4">
                        <a href="<?php echo e(route('company.kyc', ['company' => $company->id, 'tab' => 'business-client-information'])); ?>" class="inline-flex h-10 min-w-[100px] items-center justify-center rounded-full border border-gray-200 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50">
                            Cancel
                        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\company\bif\create.blade.php ENDPATH**/ ?>