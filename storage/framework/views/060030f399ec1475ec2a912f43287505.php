        ...
        <div class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
            <section class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                    <?php $__currentLoopData = $regularStages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mt-6 rounded-2xl border border-dashed border-gray-300 bg-gray-50 px-5 py-5">
                    ...
                    <div class="mt-4 flex flex-wrap gap-2 text-sm">
                        <?php $__currentLoopData = ['Overview', 'RSAT', 'NTP', 'Execution', 'Reports', 'Delivery', 'Cycle History', 'Timeline']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\ojt\jknc_work\jknc_project\resources\views/regular/index.blade.php ENDPATH**/ ?>