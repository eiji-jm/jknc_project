...
<div class="px-6 py-6 lg:px-8">
    <div class="mb-5 flex flex-wrap items-start justify-between gap-3">
        <div>
            <a href="<?php echo e(route('products.index')); ?>" class="mb-2 inline-flex items-center gap-1 text-sm text-gray-500 hover:text-blue-600">
            ...
            <h1 class="text-3xl font-semibold text-gray-900">
                ...
                <?php if($priceLabel): ?>
                    <span class="text-2xl font-semibold text-gray-700"> &middot; <?php echo e($priceLabel); ?></span>
                <?php endif; ?>
            </h1>
            <p class="mt-1 text-sm text-gray-500"><?php echo e($product->owner_name ?: 'Admin User'); ?></p>
        </div>
        ...
        <aside class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <dl class="space-y-3 text-sm">
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    ...
                    <dd class="text-gray-800"><?php echo e($product->product_id); ?></dd>
                </div>
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    <dt class="text-gray-500">SKU</dt>
                    <dd class="text-gray-800"><?php echo e($product->sku ?: '-'); ?></dd>
                </div>
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    <dt class="text-gray-500">Type</dt>
                    <dd class="text-gray-800"><?php echo e($product->product_type); ?></dd>
                </div>
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    <dt class="text-gray-500">Category</dt>
                    <dd class="text-gray-800"><?php echo e($product->category); ?></dd>
                </div>
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    <dt class="text-gray-500">Status</dt>
                    <dd class="text-gray-800"><?php echo e($product->status); ?></dd>
                </div>
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    <dt class="text-gray-500">Service Areas</dt>
                    <dd class="text-gray-800">
                        <?php echo e(collect($product->product_area ?? [])->filter()->implode(', ') ?: '-'); ?>
                ...
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    ...
                    <dd class="text-gray-800">
                        <?php echo e(collect($product->linked_service_names ?? [])->filter()->implode(', ') ?: '-'); ?>

                    </dd>
                </div>
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    <dt class="text-gray-500">Tax Type</dt>
                    <dd class="text-gray-800"><?php echo e($product->tax_type); ?></dd>
                </div>
                <div class="grid grid-cols-[120px_1fr] gap-2">
                    <dt class="text-gray-500">Tax Treatment</dt>
                    <dd class="text-gray-800"><?php echo e($product->tax_treatment ?: '-'); ?></dd>
                </div>
            </dl>

            <div class="mt-6">
                <h3 class="mb-2 text-lg font-semibold text-gray-900">Description</h3>
                <p class="text-sm text-gray-600"><?php echo e($product->product_description ?: '-'); ?></p>
            </div>

            <div class="mt-6">
                <h3 class="mb-2 text-lg font-semibold text-gray-900">Inclusions</h3>
                <div class="space-y-1 text-sm text-gray-600">
                    <?php $__empty_1 = true; $__currentLoopData = preg_split('/\r\n|\r|\n/', (string) $product->product_inclusions); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="border-b border-gray-200 px-5 pt-4">
                <nav class="flex items-center gap-5 text-sm">
                    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tabKey => $tabLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a
                            href="<?php echo e(route('products.show', ['id' => $product->product_id, 'tab' => $tabKey])); ?>"
                            class="border-b-2 pb-3 <?php echo e($tab === $tabKey ? 'border-blue-600 text-blue-700 font-medium' : 'border-transparent text-gray-600 hover:text-gray-800'); ?>"
                        >
                            <?php echo e($tabLabel); ?>
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="flex gap-3 rounded-lg border border-gray-100 bg-gray-50 p-3">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-800"><?php echo e($item['title']); ?> by <?php echo e($item['user_name']); ?></p>
                                    <p class="text-sm text-gray-600"><?php echo e($item['description']); ?></p>
                                    <p class="mt-1 text-xs text-gray-500"><?php echo e($item['created_at']); ?></p>
                                </div>
                            </article>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="mt-6 grid gap-4 sm:grid-cols-2">
                        <div class="rounded-lg border border-gray-200 p-4">
                            ...
                            <div class="mt-3 space-y-2 text-sm text-gray-600">
                                <p>Pricing Type: <span class="font-medium text-gray-800"><?php echo e($product->pricing_type); ?></span></p>
                                <p>Price: <span class="font-medium text-gray-800">P<?php echo e(number_format((float) $product->price, 2)); ?></span></p>
                                <p>Cost: <span class="font-medium text-gray-800"><?php echo e($product->cost !== null ? 'P'.number_format((float) $product->cost, 2) : '-'); ?></span></p>
                                <p>Discountable: <span class="font-medium text-gray-800"><?php echo e($product->is_discountable ? 'Yes' : 'No'); ?></span></p>
                            </div>
                        </div>
                        <div class="rounded-lg border border-gray-200 p-4">
                            <h4 class="text-sm font-semibold text-gray-900">System Info</h4>
                            <div class="mt-3 space-y-2 text-sm text-gray-600">
                                <p>Created By: <span class="font-medium text-gray-800"><?php echo e($product->created_by ?: '-'); ?></span></p>
                                <p>Created At: <span class="font-medium text-gray-800"><?php echo e($product->created_at?->format('M d, Y h:i A') ?: '-'); ?></span></p>
                                <p>Reviewed By: <span class="font-medium text-gray-800"><?php echo e($product->reviewed_by ?: '-'); ?></span></p>
                                <p>Approved By: <span class="font-medium text-gray-800"><?php echo e($product->approved_by ?: '-'); ?></span></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-6 rounded-lg border border-gray-200">
                            ...
                            <div class="grid gap-4 px-4 py-4 sm:grid-cols-2">
                                <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <p class="text-xs uppercase tracking-wide text-gray-500"><?php echo e($field->field_name); ?></p>
                                        <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e(data_get($customFieldValues, $field->field_key, '-') ?: '-'); ?></p>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views/products/show.blade.php ENDPATH**/ ?>