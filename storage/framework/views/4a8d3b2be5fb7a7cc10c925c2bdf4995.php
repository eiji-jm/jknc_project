                    ...
                    <tbody class="text-sm text-gray-900" id="installment-table-body">
                        <?php $__empty_1 = true; $__currentLoopData = $installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $installment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-search-row class="border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('stock-transfer-book.installment.show', $installment)); ?>'">
                                ...
                                <td class="px-4 py-3"><?php echo e(number_format((float) $installment->total_value, 2)); ?></td>
                                <td class="px-4 py-3">
                                    <?php
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                >
                                    ...
                                    <?php $__currentLoopData = ($indexShareholders ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($holder['name']); ?>"
                                            data-stock-number="<?php echo e($holder['stock_number']); ?>"
                                            data-shares="<?php echo e($holder['shares']); ?>"
                                            data-par-value="<?php echo e($holder['par_value']); ?>"
                                        >
                                            <?php echo e($holder['name']); ?>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm"
                                    placeholder="100.00"
                                    value="<?php echo e($defaultParValue); ?>"
                                >
                            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (openButton) {
            openButton.addEventListener('click', function () {
                ...
                <?php if(!empty($defaultParValue)): ?>
                    parValueInput.value = "<?php echo e($defaultParValue); ?>";
                <?php endif; ?>
            });
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\stock-transfer-book\installment.blade.php ENDPATH**/ ?>