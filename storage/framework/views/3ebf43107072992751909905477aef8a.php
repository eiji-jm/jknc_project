    ...
    <table>
        ...
        <tbody>
            <?php for($i = 0; $i < $maxRows; $i++): ?>
                ...
                ?>
                <tr class="row">
                    <td><?php echo e($cancel ? optional($cancel->entry_date)->format('m/d/Y') : ''); ?></td>
                    <td><?php echo e($cancel->journal_no ?? ''); ?></td>
                    <td><?php echo e($cancel->certificate_no ?? ''); ?></td>
                    <td><?php echo e($cancel->no_shares ?? ''); ?></td>
                    <td><?php echo e($issue ? optional($issue->entry_date)->format('m/d/Y') : ''); ?></td>
                    <td><?php echo e($issue->journal_no ?? ''); ?></td>
                    <td><?php echo e($issue->certificate_no ?? ''); ?></td>
                    <td><?php echo e($issue->no_shares ?? ''); ?></td>
                </tr>
            <?php endfor; ?>
        </tbody>
    </table>
</body>
</html><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\stock-transfer-book\ledger-pdf.blade.php ENDPATH**/ ?>