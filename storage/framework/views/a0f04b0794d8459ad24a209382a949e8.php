                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3 font-medium">
                                    <a href="<?php echo e(route('corporate.ubo.show', $owner)); ?>" class="text-gray-900 hover:underline">
                                        <?php echo e($owner->complete_name); ?>

                                    </a>
                                </td>
                                <td class="px-4 py-3"><?php echo e($owner->residential_address); ?></td>
                                <td class="px-4 py-3"><?php echo e($owner->nationality); ?></td>
                                <td class="px-4 py-3"><?php echo e(optional($owner->date_of_birth)->format('M d, Y')); ?></td>
                                <td class="px-4 py-3"><?php echo e($owner->tax_identification_no); ?></td>
                                <td class="px-4 py-3"><?php echo e($owner->ownership_percentage); ?></td>
                                <td class="px-4 py-3"><?php echo e($owner->ownership_type); ?></td>
                            </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\ubo-form.blade.php ENDPATH**/ ?>