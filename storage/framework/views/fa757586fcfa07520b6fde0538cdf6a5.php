                    ...
                    <div class="absolute inset-0 overflow-hidden">
                        ...
                        <div class="absolute inset-y-0 right-0 max-w-full flex">
                            <div x-show="showSlideOver" class="w-screen max-w-sm bg-white shadow-2xl flex flex-col h-full"
                                ...
                                <form id="correspondenceForm" method="POST" action="<?php echo e(route('company.correspondence.store', $company->id)); ?>" class="flex min-h-0 flex-1 flex-col">
                                    <?php echo csrf_field(); ?>
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3 border-r"><?php echo e($record['correspondence_type']); ?></td>
                                        <td class="p-3 border-r"><?php echo e($record['document_title']); ?></td>
                                        <td class="p-3 border-r"><span class="font-semibold <?php echo e($statusClass); ?>"><?php echo e($record['status']); ?></span></td>
                                        <td class="p-3">
                                            <div class="flex items-center justify-end gap-2">
                                                <button type="button" class="inline-flex h-8 items-center rounded-full border border-gray-200 px-3 text-xs font-medium text-gray-700 hover:bg-gray-50" onclick="editCorrespondenceRecord(<?php echo \Illuminate\Support\Js::from($record)->toHtml() ?>)">Edit</button>
                                                <form method="POST" action="<?php echo e(route('company.correspondence.destroy', [$company->id, $record['id']])); ?>" onsubmit="return confirm('Delete this correspondence entry?');">
                                                    <?php echo csrf_field(); ?>
...
<script>
    function resetCorrespondenceForm() {
        ...
        form.reset();
        form.action = <?php echo json_encode(route('company.correspondence.store', $company->id), 512) ?>;
    ...
    function editCorrespondenceRecord(record) {
        ...
        document.getElementById('correspondenceForm').action = <?php echo json_encode(route('company.correspondence.update', [$company->id, '__RECORD__'])) ?>.replace('__RECORD__', record.id);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\company\correspondence.blade.php ENDPATH**/ ?>