...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4">
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="flex items-center gap-3 px-4 py-4 border-b border-gray-100">
            <a href="<?php echo e(route('notices')); ?>" class="text-gray-500 hover:text-gray-700">
                <i class="fas fa-arrow-left"></i>
            </a>
            <div>
                <div class="text-lg font-semibold">Notice Preview</div>
                <div class="text-xs text-gray-500">Notice #: <?php echo e($selected->notice_number ?: 'Draft Notice'); ?></div>
            </div>
            <div class="flex-1"></div>
            <span class="px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-700"><?php echo e($selected->type_of_meeting); ?></span>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 p-6">
            <div class="lg:col-span-3 space-y-4">
                <?php if($documentUrl): ?>
                    <iframe
                        src="<?php echo e($documentUrl); ?>"
                        class="w-full h-[700px] border rounded bg-white">
                    </iframe>
                <?php else: ?>
                    <iframe
                        src="<?php echo e($generatedNoticePaneUrl); ?>"
                        class="w-full h-[700px] border rounded bg-white">
                    </iframe>
                <?php endif; ?>
            </div>
            ...
            <div class="lg:col-span-2 space-y-4">
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Governing Body</span><div class="font-medium text-gray-900"><?php echo e($selected->governing_body); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Type of Meeting</span><div class="font-medium text-gray-900"><?php echo e($selected->type_of_meeting); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Meeting Date</span><div class="font-medium text-gray-900"><?php echo e(optional($selected->date_of_meeting)->format('M d, Y')); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Time</span><div class="font-medium text-gray-900"><?php echo e($selected->time_started); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Location</span><div class="font-medium text-gray-900"><?php echo e($selected->location); ?></div></div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Notice No.</span><div class="font-medium text-gray-900"><?php echo e($selected->notice_number); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Meeting No.</span><div class="font-medium text-gray-900"><?php echo e($selected->meeting_no); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Updated</span><div class="font-medium text-gray-900"><?php echo e(optional($selected->date_updated)->format('M d, Y')); ?></div></div>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                    ...
                    <div class="space-y-3 text-sm">
                        <div>
                            ...
                            <div class="font-medium text-gray-900"><?php echo e($selected->minutes->count()); ?> linked</div>
                        </div>
                        <div>
                            <div class="text-xs text-gray-600 uppercase tracking-wide">Resolutions</div>
                            <div class="font-medium text-gray-900"><?php echo e($selected->resolutions->count()); ?> linked</div>
                        </div>
                        <div>
                            <div class="text-xs text-gray-600 uppercase tracking-wide">Secretary Certificates</div>
                            <div class="font-medium text-gray-900"><?php echo e($selected->secretaryCertificates->count()); ?> linked</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Chairman</span><div class="font-medium text-gray-900"><?php echo e($selected->chairman); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Secretary</span><div class="font-medium text-gray-900"><?php echo e($selected->secretary); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Uploaded By</span><div class="font-medium text-gray-900"><?php echo e($selected->uploaded_by); ?></div></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dimpa\Herd\jknc_project\resources\views/corporate/notices/preview.blade.php ENDPATH**/ ?>