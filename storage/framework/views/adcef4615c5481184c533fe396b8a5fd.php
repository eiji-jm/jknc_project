    ...
    <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden">
        <div class="flex items-center gap-3 px-4 py-3 border-b border-gray-100">
            ...
            <div>
                ...
                <div class="text-xs text-gray-500"><?php echo e($deal->deal_code); ?></div>
            </div>
            ...
            <span id="proposal-preview-badge" class="inline-flex rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700">
                <?php echo e($generatedPdfUrl ? 'Exact preview ready' : 'Generating preview'); ?>

            </span>
            <a
                id="proposal-docx-download"
                href="<?php echo e($generatedDocxDownloadUrl ?: '#'); ?>"
                class="inline-flex rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 <?php echo e($generatedDocxDownloadUrl ? '' : 'pointer-events-none opacity-50'); ?>"
            >
                Download DOCX
            </a>
            <a
                ...
                class="inline-flex rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 <?php echo e($generatedPdfDownloadUrl ? '' : 'pointer-events-none opacity-50'); ?>"
            >
                Download PDF
            </a>
        </div>
                    ...
                    <div class="flex items-start gap-3">
                        <div>
                            ...
                            <div id="proposal-preview-status" class="mt-1 text-xs text-gray-500">
                                <?php echo e($generatedPdfUrl ? 'This preview is rendered from the generated Word template output, so it should match the full proposal document instead of a rebuilt HTML copy.' : 'Generating the exact Word-template preview.'); ?>
                ...
                <div class="flex-1 p-5">
                    <div id="proposal-preview-panel" class="h-full rounded-2xl border border-gray-200 bg-white overflow-hidden">
                        <iframe
                            ...
                            src="<?php echo e($generatedPdfUrl ?: 'about:blank'); ?>"
                            class="proposal-preview-frame h-full w-full <?php echo e($generatedPdfUrl ? '' : 'hidden'); ?>"
                            title="Exact proposal preview"
                        ></iframe>

                        <div id="proposal-preview-placeholder" class="flex h-full min-h-[420px] items-center justify-center px-8 text-center text-sm text-gray-500 <?php echo e($generatedPdfUrl ? 'hidden' : ''); ?>">
