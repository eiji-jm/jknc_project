        ...
        <div class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
            <section class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
                    <?php $__currentLoopData = $projectStages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="rounded-xl border border-gray-200 bg-gray-50/70 p-4">
                            <p class="text-xs font-semibold uppercase tracking-wide text-blue-600"><?php echo e($loop->iteration); ?></p>
                            <h3 class="mt-2 text-base font-semibold text-gray-900"><?php echo e($stage['title']); ?></h3>
                            <p class="mt-2 text-sm text-gray-600"><?php echo e($stage['detail']); ?></p>
                        </article>
                ...
                <div class="mt-6 rounded-2xl border border-dashed border-gray-300 bg-gray-50 px-5 py-5">
                    ...
                    <div class="mt-4 flex flex-wrap gap-2 text-sm">
                        <?php $__currentLoopData = ['Overview', 'Work Order', 'SOW', 'NTP', 'Execution', 'Reports', 'Delivery', 'Completion', 'Timeline']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="rounded-full border border-gray-200 bg-white px-3 py-1.5 text-gray-700"><?php echo e($tab); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </section>
            ...
            <div class="space-y-6">
                <section class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="mt-4 space-y-2">
                        <?php $__currentLoopData = $requiredControls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="mt-4 space-y-3">
                        <?php $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="rounded-xl border border-gray-200 px-4 py-3">
                                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500"><?php echo e($form['code']); ?></p>
                                <p class="mt-1 text-sm font-semibold text-gray-900"><?php echo e($form['name']); ?></p>
                                <p class="mt-1 text-xs text-gray-500">Owner: <?php echo e($form['owner']); ?></p>
                            </article>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </section>
