                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e($project->project_code); ?></p>
                                </td>
                                ...
                                <td class="px-4 py-3 text-right">
                                    <a href="<?php echo e(route('project.show', $project)); ?>" class="inline-flex h-9 items-center rounded-full border border-gray-200 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50">View</a>
                                </td>
                            </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.slide-over','data' => ['id' => 'projectManualCreateDrawer','width' => 'sm:max-w-[760px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'projectManualCreateDrawer','width' => 'sm:max-w-[760px]']); ?>
    ...
    <form method="POST" action="<?php echo e(route('project.manual.store')); ?>" class="flex h-full flex-col overflow-hidden">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="source_mode" id="project_source_mode" value="<?php echo e($oldSourceMode === 'deal' ? 'deal' : 'manual'); ?>">
        <input type="hidden" name="deal_id" id="project_deal_id" value="<?php echo e(old('deal_id')); ?>">
        <input type="hidden" name="contact_id" id="project_contact_id" value="<?php echo e(old('contact_id')); ?>">
        <input type="hidden" name="company_id" id="project_company_id" value="<?php echo e(old('company_id')); ?>">
        <div class="flex-1 space-y-6 overflow-y-auto px-6 py-5">
            <section class="rounded-2xl border border-gray-200 bg-gray-50 p-4">
                ...
                <div class="mt-3 grid gap-3 md:grid-cols-2">
                    <button type="button" data-project-source-option="deal" class="project-source-option rounded-2xl border px-4 py-4 text-left transition <?php echo e($oldSourceMode === 'deal' ? 'border-[#102d79] bg-white ring-2 ring-[#102d79]/10' : 'border-gray-200 bg-white hover:border-gray-300'); ?>">
                    ...
                    <button type="button" data-project-source-option="manual" class="project-source-option rounded-2xl border px-4 py-4 text-left transition <?php echo e($oldSourceMode !== 'deal' ? 'border-[#102d79] bg-white ring-2 ring-[#102d79]/10' : 'border-gray-200 bg-white hover:border-gray-300'); ?>">
            ...
            <section id="projectDealLinkSection" class="space-y-3 <?php echo e($oldSourceMode === 'deal' ? '' : 'hidden'); ?>">
                <div>
                ...
                <div id="projectDealSelectionSummary" class="<?php echo e(old('deal_id') ? '' : 'hidden'); ?> rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900"></div>
            </section>

            <section id="projectManualLinkSection" class="space-y-4 <?php echo e($oldSourceMode === 'deal' ? 'hidden' : ''); ?>">
                    ...
                    <div class="mt-3 grid grid-cols-2 gap-2">
                        <?php $__currentLoopData = ['business' => 'Business', 'individual' => 'Individual']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700">
                                <input type="radio" name="project_customer_type" value="<?php echo e($value); ?>" <?php if(old('project_customer_type', 'individual') === $value): echo 'checked'; endif; ?> class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500">
                ...
                <div id="projectManualSelectionSummary" class="<?php echo e(old('contact_id') || old('company_id') ? '' : 'hidden'); ?> rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-900"></div>
            </section>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <select name="template_id" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                        ...
                        <?php $__currentLoopData = $sowTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <input name="name" id="project_name" value="<?php echo e(old('name')); ?>" required class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Client Name</label>
                    <input name="client_name" id="project_client_name" value="<?php echo e(old('client_name')); ?>" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Business Name</label>
                    <input name="business_name" id="project_business_name" value="<?php echo e(old('business_name')); ?>" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Planned Start</label>
                    <input type="date" name="planned_start_date" id="project_planned_start_date" value="<?php echo e(old('planned_start_date')); ?>" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Target Completion</label>
                    <input type="date" name="target_completion_date" id="project_target_completion_date" value="<?php echo e(old('target_completion_date')); ?>" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Client Confirmation Name</label>
                    <input name="client_confirmation_name" id="project_client_confirmation_name" value="<?php echo e(old('client_confirmation_name')); ?>" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Project Manager</label>
                    <input name="assigned_project_manager" id="project_assigned_project_manager" value="<?php echo e(old('assigned_project_manager')); ?>" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Lead Consultant</label>
                    <input name="assigned_consultant" id="project_assigned_consultant" value="<?php echo e(old('assigned_consultant')); ?>" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div class="md:col-span-2">
                    <label class="mb-2 block text-sm font-medium text-gray-700">Lead Associate</label>
                    <input name="assigned_associate" id="project_assigned_associate" value="<?php echo e(old('assigned_associate')); ?>" class="h-11 w-full rounded-xl border border-gray-300 px-4 text-sm text-gray-900">
                </div>
                <div class="md:col-span-2">
                ...
                <textarea name="products" id="project_products" class="hidden"><?php echo e(old('products')); ?></textarea>
            </div>
            ...
            <section class="rounded-2xl border border-gray-200 p-4">
                ...
                <div class="mt-4 space-y-4">
                    <div>
                        ...
                        <div id="project-service-area-options-grid" class="grid gap-2 sm:grid-cols-2">
                            <?php $__currentLoopData = $serviceAreaOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700">
                                    <input type="checkbox" name="service_area_options[]" value="<?php echo e($option); ?>" <?php if(in_array($option, $selectedServiceAreas, true)): echo 'checked'; endif; ?> <?php echo e($option === 'Others' ? 'data-other-target=project-service-area-other-wrapper' : ''); ?> class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500">
                        ...
                        <div id="project-service-area-other-wrapper" class="<?php echo e((in_array('Others', $selectedServiceAreas, true) || count($serviceAreaOtherEntries) > 0) ? '' : 'hidden'); ?> mt-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="projectServicesEmptyState" class="rounded-xl border border-dashed border-gray-200 bg-gray-50/60 p-4 text-sm text-gray-500 <?php echo e(count($selectedServiceAreas) > 0 ? 'hidden' : ''); ?>">
                            Select a service area first to show matching services.
                        </div>
                        <div id="projectServicesGrid" class="grid gap-4 lg:grid-cols-2 <?php echo e(count($selectedServiceAreas) > 0 ? '' : 'hidden'); ?>">
                            <?php $__currentLoopData = $serviceGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="rounded-xl border border-gray-200 bg-gray-50/60 p-3 <?php echo e(in_array($group, $selectedServiceAreas, true) ? '' : 'hidden'); ?>" data-project-service-group="<?php echo e($group); ?>">
                                    ...
                                    <div class="space-y-2">
                                        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-start gap-2 text-sm text-gray-700">
                                                <input type="checkbox" name="service_options[]" value="<?php echo e($option); ?>" data-project-service-group-option="<?php echo e($group); ?>" <?php if(in_array($option, $selectedServices, true)): echo 'checked'; endif; ?> class="mt-0.5 h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500">
                                                <span><?php echo e($option); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                        ...
                        <div id="project-services-custom-options" class="grid gap-2 sm:grid-cols-2">
                            <?php $__currentLoopData = $serviceCustomEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700" data-custom-option>
                        ...
                        <label class="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700">
                            <input id="project-services-other-toggle" type="checkbox" class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500" <?php echo e(count($serviceCustomEntries) > 0 ? 'checked' : ''); ?>>
                            <span>Others</span>
                        </label>
                        <div id="project-services-other-wrapper" class="<?php echo e(count($serviceCustomEntries) > 0 ? '' : 'hidden'); ?> mt-2">
            ...
            <section class="rounded-2xl border border-gray-200 p-4">
                ...
                <div id="projectProductsEmptyState" class="mt-3 rounded-xl border border-dashed border-gray-200 bg-gray-50/60 p-4 text-sm text-gray-500 <?php echo e(count(array_intersect($selectedServiceAreas, array_keys($productOptionsByServiceArea))) > 0 ? 'hidden' : ''); ?>">
                ...
                <div id="project-product-options-grid" class="mt-3 grid gap-4">
                    <?php $__currentLoopData = $productOptionsByServiceArea; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceArea => $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="<?php echo e(in_array($serviceArea, $selectedServiceAreas, true) ? '' : 'hidden'); ?>" data-project-product-group="<?php echo e($serviceArea); ?>">
                            <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-600"><?php echo e($serviceArea); ?></p>
                            <div class="grid gap-2 sm:grid-cols-2">
                                <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700" data-project-product-option data-service-area-product="<?php echo e($serviceArea); ?>" data-product-value="<?php echo e($option); ?>">
                    ...
                    <label class="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700" data-project-product-option data-product-value="Others">
                        <input type="checkbox" name="product_options[]" value="Others" <?php if(in_array('Others', $selectedProducts, true)): echo 'checked'; endif; ?> data-other-target="project_products_other_wrap" class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span>Others</span>
                    </label>
                    <?php $__currentLoopData = $productCustomEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700" data-custom-option>
                ...
                <div id="project_products_other_wrap" class="<?php echo e((in_array('Others', $selectedProducts, true) || count($productCustomEntries) > 0) ? '' : 'hidden'); ?> mt-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views/project/index.blade.php ENDPATH**/ ?>