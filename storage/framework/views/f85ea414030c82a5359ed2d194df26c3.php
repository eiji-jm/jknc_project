        ...
        <section class="flex-1 bg-white p-6">
            ...
            <?php if($tab === 'kyc'): ?>
                ...
                <div id="kycTabApp">
                                        ...
                                        <div class="flex flex-wrap items-center justify-end gap-2 text-xs">
                                            ...
                                            <button
                                                ...
                                                <?php if($cifSignedRequirement['file']): ?>
                                                    ...
                                                    data-document-path="<?php echo e($cifSignedRequirement['file']['file_path'] ?? $cifSignedRequirement['file']['path'] ?? ''); ?>"
                                                ...
                                                <div class="mt-2 flex flex-wrap gap-2">
                                                    <?php $__currentLoopData = $twoValidIds['files']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fileIndex => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <button
                                                            type="button"
                                                            data-document-trigger
                                                            data-document-path="<?php echo e($file['file_path'] ?? $file['path'] ?? ''); ?>"
                                                            data-document-key="two_valid_ids"
                                                            data-document-files="<?php echo e(json_encode(array_values(array_map(fn ($entry) => $entry['file_path'] ?? $entry['path'] ?? '', $twoValidIds['files'])))); ?>"
                                                            data-document-index="<?php echo e($fileIndex); ?>"
                                        ...
                                        <div class="flex flex-wrap items-center justify-end gap-2 text-xs">
                                            ...
                                            <button
                                                ...
                                                <?php if($twoValidFirstFile): ?>
                                                    data-document-trigger
                                                    data-document-path="<?php echo e($twoValidFirstFile['file_path'] ?? $twoValidFirstFile['path'] ?? ''); ?>"
                                                    data-document-key="two_valid_ids"
                                                    data-document-files="<?php echo e(json_encode(array_values(array_map(fn ($entry) => $entry['file_path'] ?? $entry['path'] ?? '', $twoValidIds['files'])))); ?>"
                                    ...
                                    <div class="flex items-start justify-between gap-3">
                                                ...
                                                <div class="mt-2 flex flex-wrap gap-2">
                                                    <?php $__currentLoopData = $specimenRequirement['files']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fileIndex => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <button
                                                            ...
                                                            data-document-files="<?php echo e(json_encode(array_values(array_map(fn ($entry) => $entry['file_path'] ?? $entry['path'] ?? '', $specimenRequirement['files'])))); ?>"
                                                            data-document-index="<?php echo e($fileIndex); ?>"
                                                            class="rounded-md border border-gray-200 px-2 py-1 text-[11px] text-gray-600 hover:bg-gray-50"
                                                        >
                                                            File <?php echo e($loop->iteration); ?>
                                        ...
                                        <div class="flex flex-wrap items-center justify-end gap-2 text-xs">
                                            ...
                                            <button
                                                ...
                                                <?php if($specimenRequirement['file']): ?>
                                                    data-document-trigger
                                                    data-document-path="<?php echo e($specimenRequirement['file']['file_path'] ?? $specimenRequirement['file']['path'] ?? ''); ?>"
                                                    data-document-key="specimen_signature_upload"
                                                    data-document-files="<?php echo e(json_encode(array_values(array_map(fn ($entry) => $entry['file_path'] ?? $entry['path'] ?? '', $specimenRequirement['files'] ?? [])))); ?>"
                                                    data-document-index="0"
                                                <?php endif; ?>
                                                ...
                                                <div class="mt-2 flex flex-wrap gap-2">
                                                    <?php $__currentLoopData = $tinRequirement['files']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fileIndex => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <button
                                                            ...
                                                            data-document-files="<?php echo e(json_encode(array_values(array_map(fn ($entry) => $entry['file_path'] ?? $entry['path'] ?? '', $tinRequirement['files'])))); ?>"
                                                            data-document-index="<?php echo e($fileIndex); ?>"
                                                            class="rounded-md border border-gray-200 px-2 py-1 text-[11px] text-gray-600 hover:bg-gray-50"
                                                        >
                                                            File <?php echo e($loop->iteration); ?>
                                        ...
                                        <div class="flex flex-wrap items-center justify-end gap-2 text-xs">
                                            ...
                                            <button
                                                ...
                                                <?php if($tinRequirement['file']): ?>
                                                    data-document-trigger
                                                    data-document-path="<?php echo e($tinRequirement['file']['file_path'] ?? $tinRequirement['file']['path'] ?? ''); ?>"
                                                    data-document-key="tin_proof"
                                                    data-document-files="<?php echo e(json_encode(array_values(array_map(fn ($entry) => $entry['file_path'] ?? $entry['path'] ?? '', $tinRequirement['files'] ?? [])))); ?>"
                                                    data-document-index="0"
                                                <?php endif; ?>
                                                        ...
                                                        <div class="mt-2 flex flex-wrap gap-2">
                                                            <?php $__currentLoopData = $foreignerFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fileIndex => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <button
                                                                    ...
                                                                    data-document-trigger
                                                                    data-document-path="<?php echo e($file['file_path'] ?? $file['path'] ?? ''); ?>"
                                                                    data-document-key="<?php echo e($foreignerRequirementKey); ?>"
                                                                    data-document-files="<?php echo e(json_encode(array_values(array_map(fn ($entry) => $entry['file_path'] ?? $entry['path'] ?? '', $foreignerFiles)))); ?>"
                                                                    data-document-index="<?php echo e($fileIndex); ?>"
                                                                    class="rounded-md border border-gray-200 px-2 py-1 text-[11px] text-gray-600 hover:bg-gray-50"
                                                                >
                                                                    File <?php echo e($loop->iteration); ?>
                                                ...
                                                <div class="flex flex-wrap items-center justify-end gap-2 text-xs">
                                                    ...
                                                    <button
                                                        ...
                                                        <?php if($foreignerPrimaryFile): ?>
                                                            data-document-trigger
                                                            data-document-path="<?php echo e($foreignerPrimaryFile['file_path'] ?? $foreignerPrimaryFile['path'] ?? ''); ?>"
                                                            data-document-key="<?php echo e($foreignerRequirementKey); ?>"
                                                            data-document-files="<?php echo e(json_encode(array_values(array_map(fn ($entry) => $entry['file_path'] ?? $entry['path'] ?? '', $foreignerFiles)))); ?>"
                                                            data-document-index="0"
                                                        <?php endif; ?>
                    ...
                    <form id="removeKycDocumentForm" method="POST" action="" data-action-template="<?php echo e(route('contacts.kyc.requirements.remove', ['contact' => $contact->id, 'requirement' => '__REQUIREMENT__'])); ?>" class="hidden">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                    ...
                    ?>
                    <textarea id="kycTabPayload" class="hidden" hidden><?php echo json_encode($kycTabPayload, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_AMP | JSON_HEX_QUOT); ?></textarea>
                    <script>
            ...
            <?php if($tab === 'consultation-notes'): ?>
                ...
                ?>
                <textarea id="consultationNotesPayload" class="hidden" hidden><?php echo json_encode($consultationNotesPayload, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_AMP | JSON_HEX_QUOT); ?></textarea>
...
<span id="contactIntakeOldEditFlag" data-active="<?php echo e(old('_from_contact_intake_edit') ? '1' : '0'); ?>" hidden></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\contacts\show.blade.php ENDPATH**/ ?>