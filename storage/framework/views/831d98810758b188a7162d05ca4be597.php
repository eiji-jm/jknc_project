...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4">
    <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden">
        <div class="flex items-center gap-3 px-4 py-3 border-b border-gray-100">
            <?php echo $__env->make('corporate.partials.section-ribbon', ['activeTab' => 'notices', 'topButtonLabel' => 'Add Notice'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="flex items-center gap-3 px-4 py-4 border-b border-gray-100">
            ...
            <span class="px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-700">
                <?php echo e($selected->type_of_meeting); ?>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div>
                            ...
                            <div class="font-medium text-gray-900"><?php echo e($selected->governing_body); ?></div>
                        </div>
                        <div>
                            <span class="text-xs text-gray-600 uppercase tracking-wide">Type of Meeting</span>
                            <div class="font-medium text-gray-900"><?php echo e($selected->type_of_meeting); ?></div>
                        </div>
                        <div>
                            <span class="text-xs text-gray-600 uppercase tracking-wide">Meeting Date</span>
                            <div class="font-medium text-gray-900"><?php echo e(optional($selected->date_of_meeting)->format('M d, Y')); ?></div>
                        </div>
                        <div>
                            <span class="text-xs text-gray-600 uppercase tracking-wide">Time</span>
                            <div class="font-medium text-gray-900"><?php echo e($selected->time_started); ?></div>
                        </div>
                        <div>
                            <span class="text-xs text-gray-600 uppercase tracking-wide">Location</span>
                            <div class="font-medium text-gray-900"><?php echo e($selected->location); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div>
                            ...
                            <div class="font-medium text-gray-900"><?php echo e($selected->notice_number); ?></div>
                        </div>
                        <div>
                            <span class="text-xs text-gray-600 uppercase tracking-wide">Meeting No.</span>
                            <div class="font-medium text-gray-900"><?php echo e($selected->meeting_no); ?></div>
                        </div>
                        <div>
                            <span class="text-xs text-gray-600 uppercase tracking-wide">Updated</span>
                            <div class="font-medium text-gray-900"><?php echo e(optional($selected->date_updated)->format('M d, Y')); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div>
                            ...
                            <div class="font-medium text-gray-900"><?php echo e($selected->chairman); ?></div>
                        </div>
                        <div>
                            <span class="text-xs text-gray-600 uppercase tracking-wide">Secretary</span>
                            <div class="font-medium text-gray-900"><?php echo e($selected->secretary); ?></div>
                        </div>
                        <div>
                            <span class="text-xs text-gray-600 uppercase tracking-wide">Uploaded By</span>
                            <div class="font-medium text-gray-900"><?php echo e($selected->uploaded_by); ?></div>
                        </div>
                    </div>
                </div>
            </div>
