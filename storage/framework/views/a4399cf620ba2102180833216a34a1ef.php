                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full text-sm">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white text-gray-700">
                                    <?php $__currentLoopData = $regularEngagements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $engagement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-3 py-3">
                                                <input type="checkbox" class="h-4 w-4 rounded border-gray-300 text-blue-600">
                                            </td>
                                            <td class="px-3 py-3 font-medium text-gray-800"><?php echo e($engagement['name']); ?></td>
                                            <td class="px-3 py-3"><?php echo e($engagement['frequency']); ?></td>
                                            <td class="px-3 py-3">
                                                <span class="inline-flex items-center rounded-full border border-emerald-200 bg-emerald-50 px-2.5 py-1 text-xs font-medium text-emerald-700"><?php echo e($engagement['status']); ?></span>
                                            </td>
                                            <td class="px-3 py-3"><?php echo e($engagement['start_date']); ?></td>
                                            <td class="px-3 py-3"><?php echo e($engagement['next_billing_date']); ?></td>
                                            <td class="px-3 py-3">
                                                <div class="flex items-center gap-2">
                                                    <span class="h-7 w-7 rounded-full bg-gray-100 border border-gray-200 text-[11px] font-semibold text-gray-600 inline-flex items-center justify-center"><?php echo e($engagement['owner_initials']); ?></span>
                                                    <span><?php echo e($engagement['owner']); ?></span>
                                                </div>
                                            </td>
                                            <td class="px-3 py-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views/company/regular.blade.php ENDPATH**/ ?>