    ...
    <div class="mx-auto max-w-[1320px] space-y-4">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white px-5 py-5 shadow-sm">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <form method="POST" action="<?php echo e(route('project.report.send', ['project' => $project->id, 'report' => $report->id])); ?>" class="flex w-full max-w-xl flex-col gap-3 sm:flex-row sm:items-end">
                    <?php echo csrf_field(); ?>
                    <div class="flex-1">
                                ...
                                <tbody>
                                    <?php
                                        $displayRows = collect($section['rows'])
                                            ...
                                            ->values();
                                    ?>
                                    <?php $__empty_1 = true; $__currentLoopData = $displayRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
