...
<div style="font-family: 'Times New Roman', Georgia, serif; color: #000; font-size: 12px; line-height: 1.2;">
    <div style="max-width: 760px; margin: 0 auto; padding: 10px 8px 0;">
        <div style="display: grid; grid-template-columns: 250px minmax(0, 1fr); align-items: start; gap: 16px; margin-bottom: 18px;">
            <div>
                <img src="<?php echo e($logoPath); ?>" alt="John Kelly and Company" style="max-width: 180px; height: auto; display: block;">
            </div>
        ...
        <div style="display: flex; align-items: center; gap: 18px; margin-bottom: 26px; font-size: 11px;">
            ...
            <div style="display: flex; align-items: center; gap: 6px; margin-left: auto;">
                ...
                <span style="display: inline-block; min-width: 94px; border-bottom: 1px solid #000; height: 12px;">
                    <span data-field="declaration_month"><?php echo e($doc['declaration_month']); ?></span>
                    <span data-field="declaration_day"><?php echo e($doc['declaration_day']); ?></span>
                    <span data-field="declaration_year"><?php echo e($doc['declaration_year']); ?></span>
                </span>
            </div>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; table-layout: fixed; border: 2px solid #000; font-size: 11px;">
            <tr>
                <td colspan="2" style="border: 2px solid #000; padding: 4px 6px; vertical-align: top;">
                    ...
                    <div style="padding-top: 8px; min-height: 20px;" data-field="company_name"><?php echo e($doc['company_name']); ?></div>
                </td>
            ...
            <tr>
                <td colspan="2" style="border: 2px solid #000; padding: 4px 6px; vertical-align: top;">
                    ...
                    <div style="padding-top: 8px; min-height: 20px;" data-field="ubos_0_full_name"><?php echo e($primaryUbo['full_name']); ?></div>
                </td>
            ...
            <tr>
                <td colspan="3" style="border: 2px solid #000; padding: 4px 6px; vertical-align: top;">
                    ...
                    <div style="padding-top: 8px; min-height: 28px;" data-field="ubos_0_address"><?php echo e($addressLine1); ?></div>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="border: 2px solid #000; padding: 4px 6px; vertical-align: top;">
                    ...
                    <div style="padding-top: 8px; min-height: 28px;"><?php echo e($addressLine2); ?></div>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 128px; border: 2px solid #000; padding: 4px 6px; vertical-align: top;">
                    ...
                    <div style="padding-top: 8px; min-height: 18px;" data-field="ubos_0_nationality"><?php echo e($primaryUbo['nationality']); ?></div>
                </td>
            </tr>
            <tr>
                <td style="border: 2px solid #000; padding: 4px 6px; vertical-align: top;">
                    <div style="font-weight: 700;">OCCUPATION:</div>
                    <div style="padding-top: 8px; min-height: 28px;" data-field="ubos_0_position"><?php echo e($primaryUbo['position']); ?></div>
                </td>
                <td colspan="2" style="border: 2px solid #000; padding: 4px 6px; vertical-align: top;">
...
<?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\company\requirements\partials\ubo-declaration-document.blade.php ENDPATH**/ ?>