        ...
        <section class="bg-gray-50 p-4 min-h-[760px]">
            <div class="rounded-md border border-gray-200 bg-white overflow-hidden">
                <div class="border-b border-gray-100 px-4 py-4">
                    ...
                    <div class="mt-4 flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="inline-flex items-center rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-xs font-medium text-gray-600">All: <?php echo e($projects->count()); ?></span>
                            <span class="inline-flex items-center rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-medium text-amber-700">Active: <?php echo e($projects->where('status', '!=', 'Completed')->count()); ?></span>
                            <span class="inline-flex items-center rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-medium text-emerald-700">Completed: <?php echo e($projects->where('status', 'Completed')->count()); ?></span>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white text-gray-700">
                                    <?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-3 py-3 font-medium text-gray-800"><?php echo e($project['name']); ?></td>
                                            <td class="px-3 py-3">
                                            ...
                                            <td class="px-3 py-3"><?php echo e($project['end_date']); ?></td>
                                            <td class="px-3 py-3">
                                                <div class="flex items-center gap-2">
                                                    <span class="h-7 w-7 rounded-full bg-gray-100 border border-gray-200 text-[11px] font-semibold text-gray-600 inline-flex items-center justify-center"><?php echo e($project['owner_initials']); ?></span>
                                                    <span><?php echo e($project['owner']); ?></span>
                                                </div>
                                            </td>
                                            <td class="px-3 py-3">
                                                <div class="flex items-center justify-end gap-2">
                                                    <a href="<?php echo e(route('project.show', $project['id'])); ?>" class="inline-flex h-8 items-center rounded-full bg-blue-600 px-3 text-xs font-medium text-white hover:bg-blue-700">View</a>
                ...
                <div class="border-t border-gray-100 px-4 py-3 flex flex-wrap items-center justify-end gap-3 text-sm text-gray-500">
                    <span><?php echo e($projects->count() ? '1-'.$projects->count().' of '.$projects->count().' results' : '0 results'); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views/company/projects.blade.php ENDPATH**/ ?>