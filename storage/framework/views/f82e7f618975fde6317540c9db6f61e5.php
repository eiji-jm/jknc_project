                    ...
                    <article id="deal-start-form" class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                        <div class="flex flex-wrap items-start justify-between gap-3 border-b border-gray-100 px-4 py-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <a href="<?php echo e(route('project.start.download', $project)); ?>" class="inline-flex h-9 items-center rounded-lg border border-gray-200 bg-white px-3 text-sm font-medium text-gray-700 hover:bg-gray-50">
                                    <i class="fas fa-file-arrow-down mr-1"></i>Download START PDF
                                </a>
                                <a href="<?php echo e(route('project.show', ['project' => $project->id, 'tab' => 'start'])); ?>" class="inline-flex h-9 items-center rounded-lg border border-indigo-200 bg-indigo-50 px-3 text-sm font-medium text-indigo-700 hover:bg-indigo-100">
                                    <i class="fas fa-up-right-from-square mr-1"></i>Open Full Project
                                </a>
                            </div>
                        </div>
                        <div class="p-4">
                            <?php echo $__env->make('project.partials.tab-start', [
                                'project' => $project,
                                'start' => $start,
