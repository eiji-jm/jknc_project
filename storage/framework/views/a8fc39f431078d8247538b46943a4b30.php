            ...
            <form method="POST" action="<?php echo e(route('stock-transfer-book.ledger.store')); ?>" enctype="multipart/form-data" class="p-6 overflow-y-auto space-y-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-gray-50 p-4" data-contact-empty>
                        ...
                        <a href="<?php echo e(route('contacts.index')); ?>" class="mt-3 inline-flex items-center rounded-lg border border-blue-600 px-3 py-1.5 text-xs font-medium text-blue-600 hover:bg-blue-50">
                            Go to Contacts
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\stock-transfer-book\stb-index.blade.php ENDPATH**/ ?>