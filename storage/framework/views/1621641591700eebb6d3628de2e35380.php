...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4" x-data="{ showPreview: false, showAddPanel: false, selectedEntry: null }">
    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        ...
        <?php echo $__env->make('corporate.stock-transfer-book.partials.section-tabs', ['currentStockTransferTab' => 'journal'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr data-search-row class="border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('stock-transfer-book.journal.show', $journal)); ?>'">
            <td class="px-4 py-3"><?php echo e(optional($journal->entry_date)->format('M d, Y')); ?></td>
            <td class="px-4 py-3"><?php echo e($journal->journal_no); ?></td>
            <td class="px-4 py-3"><?php echo e($journal->ledger_folio); ?></td>
            <td class="px-4 py-3"><?php echo e($journal->particulars); ?></td>
            <td class="px-4 py-3"><?php echo e($journal->no_shares); ?></td>
            <td class="px-4 py-3"><?php echo e($journal->transaction_type); ?></td>
        </tr>
    ...
    <div x-cloak>
        ...
        >
            ...
            <form method="POST" action="<?php echo e(route('stock-transfer-book.journal.store')); ?>" class="p-6 overflow-y-auto space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\stock-transfer-book\journal.blade.php ENDPATH**/ ?>