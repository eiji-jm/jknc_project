...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4" x-data="{ showAddPanel: false }" @keydown.escape.window="showAddPanel = false">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('bir-tax.preview', $tax)); ?>'">
            <td class="px-4 py-3 font-medium"><?php echo e($tax->tin); ?></td>
            <td class="px-4 py-3"><?php echo e($tax->tax_payer); ?></td>
            <td class="px-4 py-3"><?php echo e($tax->registering_office); ?></td>
            <td class="px-4 py-3"><?php echo e($tax->registered_address); ?></td>
            <td class="px-4 py-3"><?php echo e($tax->tax_types); ?></td>
            <td class="px-4 py-3"><?php echo e($tax->form_type); ?></td>
            <td class="px-4 py-3"><?php echo e($tax->filing_frequency); ?></td>
            <td class="px-4 py-3"><?php echo e(optional($tax->due_date)->format('M d, Y')); ?></td>
            <td class="px-4 py-3"><?php echo e($tax->display_status); ?></td>
        </tr>
    ...
    >
        ...
        <form method="POST" action="<?php echo e(route('bir-tax.store')); ?>" enctype="multipart/form-data" class="flex flex-1 flex-col">
            <?php echo csrf_field(); ?>
            <div class="p-6 overflow-y-auto space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="tax_payer" value="<?php echo e(old('tax_payer', $companyDefaults['tax_payer'])); ?>" data-company-default="<?php echo e($companyDefaults['tax_payer']); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Taxpayer">
                    </div>
                    <div>
                        ...
                        <select name="registering_office" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm">
                            ...
                            <?php $__currentLoopData = ['SSS', 'Pag-IBIG', 'PHILHEALTH', 'Dole']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agencyOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($agencyOption); ?>" <?php if(old('registering_office') === $agencyOption): echo 'selected'; endif; ?>><?php echo e($agencyOption); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        <label class="text-xs text-gray-600">Registered Address</label>
                        <input type="text" name="registered_address" value="<?php echo e(old('registered_address', $companyDefaults['registered_address'])); ?>" data-company-default="<?php echo e($companyDefaults['registered_address']); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Address">
                    </div>
                    <div>
                        <label class="text-xs text-gray-600">Tax Types</label>
                        <input type="text" name="tax_types" value="<?php echo e(old('tax_types')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Tax types">
                    </div>
                    <div>
                        <label class="text-xs text-gray-600">Form Type</label>
                        <input type="text" name="form_type" value="<?php echo e(old('form_type')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Form type">
                    </div>
                    <div>
                        <label class="text-xs text-gray-600">Filing Frequency</label>
                        <input type="text" name="filing_frequency" value="<?php echo e(old('filing_frequency')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Monthly/Quarterly">
                    </div>
                    <div>
                        <label class="text-xs text-gray-600">Due Date</label>
                        <input type="date" name="due_date" value="<?php echo e(old('due_date')); ?>" data-default-field="today" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm">
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\bir-tax\index.blade.php ENDPATH**/ ?>