...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4">
    <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden">
        <div class="flex items-center gap-3 px-4 py-3 border-b border-gray-100">
            <?php echo $__env->make('corporate.partials.section-ribbon', ['activeTab' => 'resolution', 'topButtonLabel' => 'Add Resolution'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4" x-data="{ activeVersion: 'draft', activeDraftPane: '<?php echo e($initialDraftPane); ?>' }">
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="flex items-center gap-3 px-4 py-4 border-b border-gray-100">
            ...
            <div>
                ...
                <div class="text-xs text-gray-500">Resolution No. <?php echo e($resolution->resolution_no ?: 'Draft'); ?></div>
            </div>
                ...
                <div>
                    <div class="rounded-2xl border border-slate-200 overflow-hidden bg-[#f8fafc] flex flex-col resolution-workspace-card">
                        ...
                        <div class="flex-1 overflow-auto p-6">
                            <?php if($generatedBodyPreviewUrl): ?>
                                <div class="mb-4 flex flex-wrap items-center justify-end gap-2">
                                    <a href="<?php echo e($generatedBodyPreviewUrl); ?>" target="_blank" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg">
                                        Download Built PDF
                                    </a>
                                    <button type="button" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-900 text-sm font-medium rounded-lg" onclick="printResolutionBuiltPdf('<?php echo e($generatedBodyPreviewUrl); ?>')">
                                        Print Built PDF
                                    </button>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="mt-12 text-center border-b border-black pb-2">
                                <div class="text-lg font-semibold uppercase underline">Board Resolution No. <span data-preview="resolution-no"><?php echo e($resolution->resolution_no ?: '25-002'); ?></span></div>
                            </div>

                            <div class="mt-8 space-y-5 text-justify">
                                <p>
                                    <span class="font-semibold">WHEREAS,</span> during the <span data-preview="meeting-type-lower"><?php echo e(strtolower($resolution->type_of_meeting ?: 'special')); ?></span>
                                    meeting of the <span data-preview="governing-body"><?php echo e($resolution->governing_body ?: 'Board of Directors'); ?></span> of
                                    <span class="font-semibold underline"><?php echo e($companyName); ?></span> held on
                                    <span class="font-semibold underline" data-preview="meeting-date"><?php echo e($meetingDate); ?></span>, where a quorum was present and acted all throughout,
                                ...
                                ><?php echo $resolution->resolution_body ?: ($resolution->board_resolution ?: 'No board resolution text has been encoded yet.'); ?></div>
                                ...
                                <p>
                                    ...
                                    and adopt it on this <span class="font-semibold underline" data-preview="meeting-date"><?php echo e($meetingDate); ?></span>.
                                </p>
                            </div>

                            <div class="mt-16 text-right">
                                <div class="inline-block min-w-[240px] border-t border-black pt-2 text-center">
                                    <div class="font-semibold uppercase" data-preview="chairman"><?php echo e($resolution->chairman ?: 'JOSE BAYBAYANON OGANG'); ?></div>
                                    <div>Chairman</div>
                                </div>
                            </div>
                            ...
                            <div class="mt-16 space-y-5 text-justify">
                                <p>
                                    IN WITNESS WHEREOF, I, <span class="font-semibold underline" data-preview="chairman"><?php echo e($resolution->chairman ?: '____________________'); ?></span>,
                                    in my capacity as chairman of the board, have signed these presents this ______ day of __________ at
                                    <span data-preview="notarized-at"><?php echo e($resolution->notarized_at ?: '______________'); ?></span>.
                                </p>
                            </div>
                            ...
                            <div class="mt-16 space-y-4 text-sm">
                                <p>
                                    ...
                                    <span data-preview="notarized-at"><?php echo e($resolution->notarized_at ?: '______________'); ?></span> this day of __________, affiant presented to me __________ issued at __________.
                                </p>
                                <div class="text-right mt-10">
                                    <div class="inline-block min-w-[220px] border-t border-black pt-2 text-center font-semibold uppercase">
                                        <span data-preview="notary-public"><?php echo e($resolution->notary_public ?: 'Notary Public'); ?></span>
                                    </div>
                                </div>
                                <div class="mt-8 space-y-1">
                                    <div>Doc. No. <span data-preview="notary-doc-no"><?php echo e($resolution->notary_doc_no ?: '_____'); ?></span>;</div>
                                    <div>Page No. <span data-preview="notary-page-no"><?php echo e($resolution->notary_page_no ?: '_____'); ?></span>;</div>
                                    <div>Book No. <span data-preview="notary-book-no"><?php echo e($resolution->notary_book_no ?: '_____'); ?></span>;</div>
                                    <div>Series of <span data-preview="notary-series-no" data-fallback-year="<?php echo e($notaryYear); ?>"><?php echo e($resolution->notary_series_no ?: $notaryYear); ?></span>.</div>
                                </div>
                            </div>
                        </div>
                            </div>
                            <?php if($draftUrl): ?>
                                <div x-show="activeDraftPane === 'attachment'" class="rounded-2xl border border-slate-200 bg-white overflow-hidden">
                                    <div class="px-4 py-3 border-b border-gray-100 flex flex-wrap items-center justify-between gap-3">
                                        ...
                                        <a href="<?php echo e($draftUrl); ?>" target="_blank" class="inline-flex rounded-lg bg-slate-800 px-4 py-2 text-sm font-medium text-white hover:bg-black">
                                            Open in New Tab
                                        </a>
                                    </div>
                                    <iframe
                ...
                <div class="rounded-2xl border border-gray-200 bg-white overflow-hidden flex flex-col resolution-workspace-card">
                    <div class="flex-1 overflow-y-auto">
                        <div class="px-6 py-5 space-y-5">
                            <div class="rounded-2xl border border-gray-200 overflow-hidden sticky top-0 bg-white z-10 shadow-sm">
                                ...
                                <form method="POST" action="<?php echo e(route('resolutions.update', $resolution)); ?>" enctype="multipart/form-data" class="space-y-5" id="resolution-live-form">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <input type="hidden" name="minute_id" value="<?php echo e($resolution->minute_id); ?>">
                    <input type="hidden" name="notice_id" value="<?php echo e($resolution->notice_id); ?>">
                    <div class="px-4 py-4 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            <label class="text-xs text-gray-600">Resolution No.</label>
                            <input type="text" name="resolution_no" value="<?php echo e($resolution->resolution_no); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="resolution-no" data-live-empty="25-002">
                        </div>
                        <div>
                            <label class="text-xs text-gray-600">Meeting Date</label>
                            <input type="date" name="date_of_meeting" value="<?php echo e(optional($resolution->date_of_meeting)->toDateString()); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="meeting-date" data-live-format="resolution-date-group">
                        </div>
                        <div>
                            ...
                            <select name="governing_body" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="governing-body">
                                <?php $__currentLoopData = ['Stockholders', 'Board of Directors', 'Joint Stockholders and Board of Directors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bodyOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($bodyOption); ?>" <?php if($resolution->governing_body === $bodyOption): echo 'selected'; endif; ?>><?php echo e($bodyOption); ?></option>
                        ...
                        <div>
                            ...
                            <select name="type_of_meeting" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="meeting-type" data-live-format="meeting-type-group">
                                <?php $__currentLoopData = ['Regular', 'Special']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meetingTypeOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($meetingTypeOption); ?>" <?php if($resolution->type_of_meeting === $meetingTypeOption): echo 'selected'; endif; ?>><?php echo e($meetingTypeOption); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="md:col-span-2">
                            <label class="text-xs text-gray-600">Board Resolution</label>
                            <input type="text" name="board_resolution" value="<?php echo e($resolution->board_resolution); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="board-resolution">
                        </div>
                        <div class="md:col-span-2">
                            <div class="border border-gray-200 rounded-xl overflow-hidden">
                                ...
                                ><?php echo $resolution->resolution_body ?: ''; ?></div>
                                <input type="hidden" name="resolution_body" id="resolution-body-input" value="<?php echo e($resolution->resolution_body); ?>" data-live-target="resolution-body" data-live-format="multiline" data-live-empty="No board resolution text has been encoded yet.">
                            </div>
                        </div>
                        <div>
                            <label class="text-xs text-gray-600">Chairman</label>
                            <input type="text" name="chairman" value="<?php echo e($resolution->chairman); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="chairman" data-live-empty="JOSE BAYBAYANON OGANG">
                        </div>
                        <div>
                            <label class="text-xs text-gray-600">Secretary</label>
                            <input type="text" name="secretary" value="<?php echo e($resolution->secretary); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="secretary-name" data-live-empty="Name of secretary">
                        </div>
                        <div class="md:col-span-2">
                            <label class="text-xs text-gray-600">Directors</label>
                            <input type="text" name="directors" value="<?php echo e($resolution->directors); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <?php if($resolution->notarized_file_path): ?>
                        ...
                        <div>
                            ...
                            <?php if($resolution->draft_file_path): ?>
                                <label class="mt-2 inline-flex items-center gap-2 text-xs font-medium text-red-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="notary_public" value="<?php echo e($resolution->notary_public); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="notary-public" data-live-empty="NOTARY PUBLIC">
                        </div>
                        <div>
                            <label class="text-xs text-gray-600">Notarized At</label>
                            <input type="text" name="notarized_at" value="<?php echo e($resolution->notarized_at); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="notarized-at" data-live-empty="______________">
                        </div>
                        <div>
                            <label class="text-xs text-gray-600">Notarized On</label>
                            <input type="date" name="notarized_on" value="<?php echo e(optional($resolution->notarized_on)->toDateString()); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="notary-series-no" data-live-format="year-fallback">
                        </div>
                        <div>
                            <label class="text-xs text-gray-600">Doc No.</label>
                            <input type="text" name="notary_doc_no" value="<?php echo e($resolution->notary_doc_no); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="notary-doc-no" data-live-empty="_____">
                        </div>
                        <div>
                            <label class="text-xs text-gray-600">Page No.</label>
                            <input type="text" name="notary_page_no" value="<?php echo e($resolution->notary_page_no); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="notary-page-no" data-live-empty="_____">
                        </div>
                        <div>
                            <label class="text-xs text-gray-600">Book No.</label>
                            <input type="text" name="notary_book_no" value="<?php echo e($resolution->notary_book_no); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="notary-book-no" data-live-empty="_____">
                        </div>
                        <div class="md:col-span-2">
                            <label class="text-xs text-gray-600">Series No.</label>
                            <input type="text" name="notary_series_no" value="<?php echo e($resolution->notary_series_no); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" data-live-target="notary-series-no">
                        </div>
                    </div>
                        ...
                        Save Resolution Changes
                            ...
                            <div class="rounded-xl border border-blue-200 bg-blue-50 p-4">
                                ...
                                <div class="space-y-2 text-sm">
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Linked Notice</span><div class="font-medium text-gray-900"><?php echo e($resolution->notice_ref); ?></div></div>
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Governing Body</span><div class="font-medium text-gray-900" data-preview="governing-body"><?php echo e($resolution->governing_body); ?></div></div>
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Meeting Type</span><div class="font-medium text-gray-900" data-preview="meeting-type"><?php echo e($resolution->type_of_meeting); ?></div></div>
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Meeting Date</span><div class="font-medium text-gray-900" data-preview="meeting-date-short"><?php echo e(optional($resolution->date_of_meeting)->format('M d, Y')); ?></div></div>
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Board Resolution</span><div class="font-medium text-gray-900" data-preview="board-resolution"><?php echo e($resolution->board_resolution); ?></div></div>
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Secretary Certificates</span><div class="font-medium text-gray-900"><?php echo e($resolution->secretaryCertificates->count()); ?> linked</div></div>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl border border-yellow-200 bg-yellow-50 p-4">
                                ...
                                <div class="space-y-2 text-sm">
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Chairman</span><div class="font-medium text-gray-900"><?php echo e($resolution->chairman); ?></div></div>
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Secretary</span><div class="font-medium text-gray-900"><?php echo e($resolution->secretary); ?></div></div>
                                    <div><span class="text-xs text-gray-600 uppercase tracking-wide">Directors</span><div class="font-medium text-gray-900"><?php echo e($resolution->directors); ?></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\resolutions\preview.blade.php ENDPATH**/ ?>