...
<div class="w-full px-6 py-6"
        ...
        <div class="bg-white border rounded-lg">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm border border-gray-300">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $gis->authorizedCapital; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-blue-50">
                                <td class="border px-4 py-3"><?php echo e($row->share_type); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->number_of_shares, 0)); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->par_value, 2)); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->amount, 2)); ?></td>
                            </tr>
                    ...
                    <tfoot class="bg-gray-50 font-semibold">
                        <tr>
                            ...
                            <td class="border px-4 py-3"><?php echo e(number_format($authorizedTotalShares, 0)); ?></td>
                            <td class="border px-4 py-3">—</td>
                            <td class="border px-4 py-3"><?php echo e(number_format($authorizedTotalAmount, 2)); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <div class="bg-white border rounded-lg">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm border border-gray-300">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $gis->subscribedCapital; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-blue-50">
                                <td class="border px-4 py-3"><?php echo e($row->nationality); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->no_of_stockholders, 0)); ?></td>
                                <td class="border px-4 py-3"><?php echo e($row->share_type); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->number_of_shares, 0)); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->par_value, 2)); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->amount, 2)); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->ownership_percentage, 2)); ?>%</td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                    ...
                    <tfoot class="bg-gray-50 font-semibold">
                        <tr>
                            <td class="border px-4 py-3 text-right">TOTAL</td>
                            <td class="border px-4 py-3"><?php echo e(number_format($subscribedTotalStockholders, 0)); ?></td>
                            <td class="border px-4 py-3">—</td>
                            <td class="border px-4 py-3"><?php echo e(number_format($subscribedTotalShares, 0)); ?></td>
                            <td class="border px-4 py-3">—</td>
                            <td class="border px-4 py-3"><?php echo e(number_format($subscribedTotalAmount, 2)); ?></td>
                            <td class="border px-4 py-3"><?php echo e(number_format($subscribedTotalOwnership, 2)); ?>%</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <div class="bg-white border rounded-lg">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm border border-gray-300">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $gis->paidUpCapital; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-blue-50">
                                <td class="border px-4 py-3"><?php echo e($row->nationality); ?></td>
                                <td class="border px-4 py-3"><?php echo e(number_format($row->no_of_stockholders, 0)); ?></td>
                                <td class="border px-4 py-3"><?php echo e($row->share_type); ?></td>
                    ...
                    <tfoot class="bg-gray-50 font-semibold">
                        <tr>
                            <td class="border px-4 py-3 text-right">TOTAL</td>
                            <td class="border px-4 py-3"><?php echo e(number_format($paidupTotalStockholders, 0)); ?></td>
                            <td class="border px-4 py-3">—</td>
                            <td class="border px-4 py-3"><?php echo e(number_format($paidupTotalShares, 0)); ?></td>
                            <td class="border px-4 py-3">—</td>
                            <td class="border px-4 py-3"><?php echo e(number_format($paidupTotalAmount, 2)); ?></td>
                            <td class="border px-4 py-3"><?php echo e(number_format($paidupTotalOwnership, 2)); ?>%</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
    ...
    <div x-show="tab=='directors'" class="bg-white border rounded-lg mb-10">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm border border-gray-300">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $gis->directors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-blue-50">
                            <td class="border px-4 py-3"><?php echo e($row->officer_name); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->address); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->nationality); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->incr ? 'Y' : 'N'); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->board); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->gender); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->stockholder ? 'Y' : 'N'); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->officer_type); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->committee); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->tin); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
    ...
    <div x-show="tab=='stockholders'" class="bg-white border rounded-lg mb-10">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm border border-gray-300">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $gis->stockholders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-blue-50">
                            <td class="border px-4 py-3"><?php echo e($row->stockholder_name); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->address); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->gender); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->nationality); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->incr ? 'Y' : 'N'); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->share_type); ?></td>
                            <td class="border px-4 py-3"><?php echo e(number_format($row->shares, 0)); ?></td>
                            <td class="border px-4 py-3"><?php echo e(number_format($row->amount, 2)); ?></td>
                            <td class="border px-4 py-3"><?php echo e(number_format($row->ownership_percentage, 2)); ?>%</td>
                            <td class="border px-4 py-3"><?php echo e(number_format($row->amount_paid, 2)); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->tin); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                ...
                <tfoot class="bg-gray-50 font-semibold">
                    <tr>
                        ...
                        <td class="border px-4 py-3"><?php echo e(number_format($stockholderTotalShares, 0)); ?></td>
                        <td class="border px-4 py-3"><?php echo e(number_format($stockholderTotalAmount, 2)); ?></td>
                        <td class="border px-4 py-3"><?php echo e(number_format($stockholderTotalOwnership, 2)); ?>%</td>
                        <td class="border px-4 py-3"><?php echo e(number_format($stockholderTotalPaid, 2)); ?></td>
                        <td class="border px-4 py-3">—</td>
                    </tr>
                </tfoot>
            </table>
    ...
    <div x-show="tab=='ubo'" class="bg-white border rounded-lg mb-10">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm border border-gray-300">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $gis->ubos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-blue-50">
                            <td class="border px-4 py-3"><?php echo e($row->complete_name); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->specific_residential_address ?: '—'); ?></td>
                            <td class="border px-4 py-3"><?php echo e($row->nationality ?: '—'); ?></td>
                            <td class="border px-4 py-3">
                                <?php echo e($row->date_of_birth ? $row->date_of_birth->format('M d, Y') : '—'); ?>

                            </td>
                            <td class="border px-4 py-3"><?php echo e($row->tax_identification_no ?: '—'); ?></td>
                            <td class="border px-4 py-3">
                                <?php echo e($row->ownership_voting_rights !== null ? number_format($row->ownership_voting_rights, 2) . '%' : '—'); ?>

                            </td>
                            <td class="border px-4 py-3">
                                <?php echo e($row->beneficial_owner_type === 'D' ? 'Direct (D)' : ($row->beneficial_owner_type === 'I' ? 'Indirect (I)' : '—')); ?>

                            </td>
                            <td class="border px-4 py-3"><?php echo e($row->beneficial_ownership_category ?: '—'); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                ...
                <tfoot class="bg-gray-50 font-semibold">
                    <tr>
                        ...
                        <td class="border px-4 py-3"><?php echo e(number_format($uboTotalOwnership, 2)); ?>%</td>
    ...
    <div x-show="panel" class="fixed inset-0 bg-black/40 z-50" x-cloak>
        <div
            ...
            <form x-show="panel=='authorized'" action="<?php echo e(route('authorized.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="gis_id" value="<?php echo e($gis->id); ?>">
            ...
            <form x-show="panel=='subscribed'" action="<?php echo e(route('subscribed.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="gis_id" value="<?php echo e($gis->id); ?>">
            ...
            <form x-show="panel=='paidup'" action="<?php echo e(route('paidup.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="gis_id" value="<?php echo e($gis->id); ?>">
            ...
            <form x-show="panel=='director'" action="<?php echo e(route('director.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="gis_id" value="<?php echo e($gis->id); ?>">
            ...
            <form x-show="panel=='stockholder'" action="<?php echo e(route('stockholder.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="gis_id" value="<?php echo e($gis->id); ?>">
            ...
            <form x-show="panel=='ubo'" action="<?php echo e(route('ubo.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="gis_id" value="<?php echo e($gis->id); ?>">
            ...
            <form x-show="panel=='completegis'" action="<?php echo e(route('gis.company.update', $gis->id)); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>

                <h3 class="text-sm font-semibold text-gray-700 uppercase">Complete / Edit GIS Information</h3>

                <input type="date" name="date_registered" class="border w-full p-2 rounded" value="<?php echo e($gis->date_registered); ?>">
                <input name="trade_name" placeholder="Trade Name" class="border w-full p-2 rounded" value="<?php echo e($gis->trade_name); ?>">
                <input name="fiscal_year_end" placeholder="Fiscal Year End" class="border w-full p-2 rounded" value="<?php echo e($gis->fiscal_year_end); ?>">
                <input name="tin" placeholder="TIN" class="border w-full p-2 rounded" value="<?php echo e($gis->tin); ?>">
                <input name="website" placeholder="Website" class="border w-full p-2 rounded" value="<?php echo e($gis->website); ?>">
                <input type="email" name="email" placeholder="Email" class="border w-full p-2 rounded" value="<?php echo e($gis->email); ?>">
                <input name="principal_address" placeholder="Principal Address" class="border w-full p-2 rounded" value="<?php echo e($gis->principal_address); ?>">
                <input name="business_address" placeholder="Business Address" class="border w-full p-2 rounded" value="<?php echo e($gis->business_address); ?>">
                <input name="official_mobile" placeholder="Official Mobile" class="border w-full p-2 rounded" value="<?php echo e($gis->official_mobile); ?>">
                <input name="alternate_mobile" placeholder="Alternate Mobile" class="border w-full p-2 rounded" value="<?php echo e($gis->alternate_mobile); ?>">
                <input name="auditor" placeholder="Auditor" class="border w-full p-2 rounded" value="<?php echo e($gis->auditor); ?>">
                <input name="industry" placeholder="Industry" class="border w-full p-2 rounded" value="<?php echo e($gis->industry); ?>">
                <input name="geo_code" placeholder="Geo Code" class="border w-full p-2 rounded" value="<?php echo e($gis->geo_code); ?>">

                <div class="border-t pt-4 mt-2">
                    <h4 class="text-sm font-semibold text-gray-700 uppercase mb-3">Intercompany Affiliations</h4>

                    <input name="parent_company_name" placeholder="Parent Company Name" class="border w-full p-2 rounded mb-3" value="<?php echo e($gis->parent_company_name); ?>">
                    <input name="parent_company_sec_no" placeholder="Parent Company SEC Registration No." class="border w-full p-2 rounded mb-3" value="<?php echo e($gis->parent_company_sec_no); ?>">
                    <input name="parent_company_address" placeholder="Parent Company Address" class="border w-full p-2 rounded mb-3" value="<?php echo e($gis->parent_company_address); ?>">

                    <input name="subsidiary_name" placeholder="Subsidiary / Affiliate Name" class="border w-full p-2 rounded mb-3" value="<?php echo e($gis->subsidiary_name); ?>">
                    <input name="subsidiary_sec_no" placeholder="Subsidiary / Affiliate SEC Registration No." class="border w-full p-2 rounded mb-3" value="<?php echo e($gis->subsidiary_sec_no); ?>">
                    <input name="subsidiary_address" placeholder="Subsidiary / Affiliate Address" class="border w-full p-2 rounded" value="<?php echo e($gis->subsidiary_address); ?>">
                </div>
    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="col-span-2 bg-white border rounded-lg p-4">
            ...
            <div x-show="fileTab === 'draft'">
                <?php if($draftUrl): ?>
                    <iframe src="<?php echo e($draftUrl); ?>" class="w-full h-[700px] border rounded"></iframe>
                <?php else: ?>
            ...
            <div x-show="fileTab === 'notary'" x-cloak>
                <?php if($notaryUrl): ?>
                    <iframe src="<?php echo e($notaryUrl); ?>" class="w-full h-[700px] border rounded"></iframe>
                <?php else: ?>
                    <div class="text-gray-400 text-center p-20 border rounded bg-gray-50">
        ...
        <div class="bg-white border rounded-lg p-6 space-y-4 h-fit">
            ...
            <div class="flex justify-between">
                ...
                <span><?php echo e($gis->corporation_name); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Company Reg No.</span>
                <span><?php echo e($gis->company_reg_no); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Uploaded By</span>
                <span><?php echo e($gis->uploaded_by); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Submission Status</span>
                <span><?php echo e($gis->submission_status); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Receive On</span>
                <span><?php echo e($gis->receive_on); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Period Date</span>
                <span><?php echo e($gis->period_date); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Annual Meeting</span>
                <span><?php echo e($gis->annual_meeting); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Meeting Type</span>
                <span><?php echo e($gis->meeting_type); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Workflow Status</span>
                <span><?php echo e($gis->workflow_status ?? 'Uploaded'); ?></span>
            </div>
            ...
            <div class="pt-1 border-t-0">
                ...
                <?php if($draftUrl): ?>
                    <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-3 py-3 mb-3">
                        <div>
                            ...
                            <p class="text-xs text-gray-400"><?php echo e(basename($gis->file)); ?></p>
                        </div>
                ...
                <?php if($canEditRecord): ?>
                    <form x-show="editDraft || !<?php echo e($draftUrl ? 'true' : 'false'); ?>" x-cloak
                          action="<?php echo e(route('corporate.gis.upload.draft', $gis->id)); ?>"
                          method="POST"
            ...
            <div class="pt-4 border-t border-gray-100">
                ...
                <?php if($notaryUrl): ?>
                    <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-3 py-3 mb-3">
                        <div>
                            ...
                            <p class="text-xs text-gray-400"><?php echo e(basename($gis->notary_file_path)); ?></p>
                        </div>
                ...
                <?php if($canEditRecord): ?>
                    <form x-show="editNotary || !<?php echo e($notaryUrl ? 'true' : 'false'); ?>" x-cloak
                          action="<?php echo e(route('corporate.gis.upload.notary', $gis->id)); ?>"
                          method="POST"
                          enctype="multipart/form-data"
                          class="space-y-3">
                        <?php echo csrf_field(); ?>
            ...
            <div class="flex justify-between">
                ...
                <span><?php echo e($gis->date_registered ? \Carbon\Carbon::parse($gis->date_registered)->format('F d, Y') : '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Trade Name</span>
                <span><?php echo e($gis->trade_name ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Fiscal Year End</span>
                <span><?php echo e($gis->fiscal_year_end ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">TIN</span>
                <span><?php echo e($gis->tin ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Website</span>
                <span class="text-right break-all"><?php echo e($gis->website ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Email</span>
                <span class="text-right break-all"><?php echo e($gis->email ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Principal Address</span>
                <span class="text-right max-w-[180px]"><?php echo e($gis->principal_address ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Business Address</span>
                <span class="text-right max-w-[180px]"><?php echo e($gis->business_address ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Official Mobile</span>
                <span><?php echo e($gis->official_mobile ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Alternate Mobile</span>
                <span><?php echo e($gis->alternate_mobile ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Auditor</span>
                <span class="text-right max-w-[180px]"><?php echo e($gis->auditor ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Industry</span>
                <span class="text-right max-w-[180px]"><?php echo e($gis->industry ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Geo Code</span>
                <span><?php echo e($gis->geo_code ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Parent Company</span>
                <span class="text-right max-w-[180px]"><?php echo e($gis->parent_company_name ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Parent SEC No.</span>
                <span><?php echo e($gis->parent_company_sec_no ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Parent Address</span>
                <span class="text-right max-w-[180px]"><?php echo e($gis->parent_company_address ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Subsidiary / Affiliate</span>
                <span class="text-right max-w-[180px]"><?php echo e($gis->subsidiary_name ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Subsidiary SEC No.</span>
                <span><?php echo e($gis->subsidiary_sec_no ?: '—'); ?></span>
            </div>

            <div class="flex justify-between">
                <span class="text-gray-500">Subsidiary Address</span>
                <span class="text-right max-w-[180px]"><?php echo e($gis->subsidiary_address ?: '—'); ?></span>
            </div>

            <?php if(!$gis->date_registered): ?>
                <button
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\gis-show.blade.php ENDPATH**/ ?>