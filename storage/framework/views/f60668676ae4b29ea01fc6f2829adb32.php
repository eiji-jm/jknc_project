    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="flex flex-wrap items-center gap-3 px-4 py-4 border-b border-gray-100">
            ...
            <div>
                ...
                <div class="text-xs text-gray-500">Reference: <?php echo e($minute->minutes_ref ?? '-'); ?></div>
            </div>
        ...
        <div class="flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 p-1">
            ...
            <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($minute->approved_by ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'); ?>">
                <?php echo e($minute->approved_by ? 'Approved' : 'Pending approval'); ?>

            </span>
            <span class="px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-700"><?php echo e($minute->meeting_mode ?? '-'); ?></span>
            ...
            <?php endif; ?>
            <a href="<?php echo e($editRoute); ?>" class="px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold">Edit</a>
            <form method="POST" action="<?php echo e($deleteRoute); ?>" onsubmit="return confirm('Delete these minutes?');">
                <?php echo csrf_field(); ?>
                ...
                <section data-preview-tab="ongoing" class="space-y-4">
                    <div class="bg-gray-900 rounded-xl overflow-hidden">
                        <div class="bg-gray-800 px-4 py-3 flex items-center gap-2 border-b border-gray-700">
                            ...
                            <button
                                ...
                                <?php if(!$documentUrl): echo 'disabled'; endif; ?>
                                onclick="handleMinutesPrint(<?php echo \Illuminate\Support\Js::from($documentUrl)->toHtml() ?>)">
                                <i class="fas fa-print"></i>
                            </button>
                            <button
                                type="button"
                                class="p-2 hover:bg-gray-700 rounded text-gray-300 transition disabled:cursor-not-allowed disabled:opacity-40"
                                <?php if(!$documentDownloadUrl): echo 'disabled'; endif; ?>
                                onclick="handleMinutesDownload(<?php echo \Illuminate\Support\Js::from($documentDownloadUrl)->toHtml() ?>)">
                                <i class="fas fa-download"></i>
                            </button>
                        </div>
                        <div class="p-6 text-center text-gray-300">
                            <p class="text-lg font-semibold">Capture the live meeting package</p>
                            <p class="text-sm text-gray-400 mt-1"><?php echo e($minute->location ?? '-'); ?> • <?php echo e(optional($minute->date_of_meeting)->format('Y-m-d') ?? '-'); ?></p>
                            ...
                            <?php if($minute->call_link): ?>
                                <p class="text-xs text-gray-400 mt-3">Call Link: <?php echo e($minute->call_link); ?></p>
                            <?php endif; ?>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-xl p-4 space-y-4">
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                            ...
                            <textarea id="minutes-script-editor" rows="10" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm" placeholder="Write the script, discussion outline, or final speaking flow here..."><?php echo e($minute->script_text ?? ''); ?></textarea>
                        </div>
                    </div>
                            ...
                            <div class="flex-1 overflow-auto p-6">
                                <div class="mx-auto max-w-[860px] rounded-sm bg-white px-14 py-12 shadow-[0_18px_50px_rgba(15,23,42,0.08)]" style="font-family: Georgia, 'Times New Roman', serif;">
                                    <div class="text-center">
                                        ...
                                        <div class="mt-10 text-[20px] font-bold"><?php echo e($minute->type_of_meeting ?: 'Special'); ?> <?php echo e($minute->governing_body ?: 'Directors'); ?> Meeting</div>
                                        ...
                                        <div class="mt-1 text-[16px] italic"><?php echo e($minute->location ?: '________________'); ?></div>
                                        <div class="mt-5 text-[16px] italic">On</div>
                                        <div class="mt-1 text-[16px] italic"><?php echo e(optional($minute->date_of_meeting)->format('F d, Y') ?: '________________'); ?></div>
                                    </div>
                                        ...
                                        <table class="mt-3 w-full table-fixed border-collapse text-[14px] leading-6">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="w-[40%] py-1"><?php echo e($minute->chairman ?: '________________'); ?></td>
                                                    <td class="py-1">President/Chairman</td>
                                                </tr>
                                                <tr>
                                                    <td class="py-1"></td>
                                                    <td class="py-1"><?php echo e($minute->secretary ?: '________________'); ?></td>
                                                    <td class="py-1">Corporate Secretary</td>
                                                </tr>
                                                <tr>
                                                    <td class="py-1 font-semibold">Other Attendee:</td>
                                                    <td class="py-1"><?php echo e($minute->uploaded_by ?: '________________'); ?></td>
                                    ...
                                    <table class="mt-12 w-full table-fixed border-collapse text-[14px] leading-6">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="w-[32%] border-b border-slate-300"><?php echo e($minute->secretary ?: '________________'); ?></td>
                                                <td class="w-[16%]"></td>
                                                <td class="w-[32%] border-b border-slate-300"><?php echo e($minute->chairman ?: '________________'); ?></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                            ...
                            <div class="flex-1 overflow-y-auto">
                                <div class="px-6 py-5 space-y-5">
                                    <div class="rounded-2xl border border-gray-200 overflow-hidden sticky top-0 bg-white z-10 shadow-sm">
                                        ...
                                        <div id="notes-editor" class="minutes-rich-editor min-h-[360px] p-4 text-sm leading-7 outline-none" contenteditable="true" data-placeholder="Type the minutes of meeting here..."><?php echo $minute->recording_notes ?: ''; ?></div>
                                    </div>
                    ...
                    <div id="minutes-print" class="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-blue-50 p-6 shadow-sm">
                        <div class="flex flex-wrap items-start justify-between gap-4 border-b border-slate-200 pb-4">
                            <div>
                                ...
                                <h2 class="mt-2 text-2xl font-semibold text-slate-900"><?php echo e($minute->governing_body ?? 'Minutes of Meeting'); ?></h2>
                                <p class="mt-1 text-sm text-slate-600"><?php echo e($minute->type_of_meeting ?? 'Meeting'); ?> meeting for <?php echo e(optional($minute->date_of_meeting)->format('F d, Y') ?? '-'); ?></p>
                            </div>
                            <div class="rounded-2xl border border-blue-200 bg-white px-4 py-3 text-sm text-slate-700">
                                <div class="font-semibold text-slate-900"><?php echo e($minute->minutes_ref ?? '-'); ?></div>
                                <div class="mt-1">Prepared by <?php echo e($minute->secretary ?? '-'); ?></div>
                                <div><?php echo e($minute->uploaded_by ?? 'System User'); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="rounded-xl border border-slate-200 bg-white p-4">
                                ...
                                <div class="mt-3 space-y-2 text-sm text-slate-700">
                                    <div><span class="font-semibold text-slate-900">Date:</span> <?php echo e(optional($minute->date_of_meeting)->format('F d, Y') ?? '-'); ?></div>
                                    <div><span class="font-semibold text-slate-900">Time:</span> <?php echo e($minute->time_started ?? '-'); ?> - <?php echo e($minute->time_ended ?? '-'); ?></div>
                                    <div><span class="font-semibold text-slate-900">Location:</span> <?php echo e($minute->location ?? '-'); ?></div>
                                    <div><span class="font-semibold text-slate-900">Mode:</span> <?php echo e($minute->meeting_mode ?? '-'); ?></div>
                                </div>
                            </div>
                            <div class="rounded-xl border border-slate-200 bg-white p-4">
                                ...
                                <div class="mt-3 space-y-3 text-sm text-slate-700">
                                    <div class="flex flex-wrap items-center justify-between gap-3">
                                        ...
                                        <?php if($documentDownloadUrl): ?>
                                            <a href="<?php echo e($documentDownloadUrl); ?>" class="shrink-0 rounded-lg bg-blue-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-blue-700">Download</a>
                                        <?php else: ?>
                                    ...
                                    <div class="flex flex-wrap items-center justify-between gap-3">
                                        ...
                                        <?php if($approvedMinutesDownloadUrl): ?>
                                            <a href="<?php echo e($approvedMinutesDownloadUrl); ?>" class="shrink-0 rounded-lg bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-emerald-700">Download</a>
                                        <?php else: ?>
                            ...
                            <div class="rounded-xl border border-slate-200 bg-white p-5">
                                <div class="flex items-start justify-between gap-4 border-b border-slate-200 pb-4">
                                    ...
                                    <div class="text-right text-[11px] leading-5 text-slate-500">
                                        <div><?php echo e($minute->minutes_ref ?? '-'); ?></div>
                                        <div><?php echo e(optional($minute->date_of_meeting)->format('F d, Y') ?? '-'); ?></div>
                                    </div>
                                </div>
                                <div class="mt-5 rounded-2xl border border-slate-200 bg-slate-50 overflow-hidden">
                                    <?php if($templatePreviewUrl): ?>
                                        <iframe id="minutes-template-pdf-frame" src="<?php echo e($templatePreviewUrl); ?>" class="h-[720px] w-full bg-white"></iframe>
...
<script>
    ...
    syncFinalNotes();
    syncFinalScript();
    syncTemplatePdfPreview(<?php echo \Illuminate\Support\Js::from($templatePreviewUrl)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($templatePreviewDownloadUrl)->toHtml() ?>);
    ...
    (() => {
        ...
        const draftKey = <?php echo \Illuminate\Support\Js::from('minute-draft-' . $minute->id)->toHtml() ?>;
        ...
        let recordingClips = <?php echo \Illuminate\Support\Js::from($recordingClipOptions)->toHtml() ?>;
        ...
        const csrfToken = <?php echo \Illuminate\Support\Js::from(csrf_token())->toHtml() ?>;
        const workspaceSaveUrl = <?php echo \Illuminate\Support\Js::from(route('minutes.workspace-save', $minute))->toHtml() ?>;
        const finalAudioSaveUrl = <?php echo \Illuminate\Support\Js::from(route('minutes.final-audio', $minute))->toHtml() ?>;
        const finalSaveUrl = <?php echo \Illuminate\Support\Js::from(route('minutes.final-save', $minute))->toHtml() ?>;
        ...
        replaceSavedClips(<?php echo \Illuminate\Support\Js::from($recordingClipOptions)->toHtml() ?>);
        if (!recordingClips.length && <?php echo \Illuminate\Support\Js::from($tentativeAudioUrl)->toHtml() ?>) {
            addClip(
                null,
                <?php echo \Illuminate\Support\Js::from($minute->tentative_audio_path ? basename($minute->tentative_audio_path) : 'tentative-recording.webm')->toHtml() ?>,
                true,
                <?php echo \Illuminate\Support\Js::from($tentativeAudioUrl)->toHtml() ?>,
                <?php echo \Illuminate\Support\Js::from($tentativeAudioDownloadUrl)->toHtml() ?>,
                'tentative-audio'
            );
        }
        syncFinalAudio(null, finalAudioFilenameValue);
        ...
        syncScriptFile(null, '');
        setIdleState();
        if (<?php echo \Illuminate\Support\Js::from($meetingVideoUrl)->toHtml() ?>) {
            syncPreviewVideo(
                <?php echo \Illuminate\Support\Js::from($meetingVideoUrl)->toHtml() ?>,
                <?php echo \Illuminate\Support\Js::from($minute->meeting_video_path ? basename($minute->meeting_video_path) : null)->toHtml() ?>,
                <?php echo \Illuminate\Support\Js::from($meetingVideoDownloadUrl)->toHtml() ?>
            );
        }
        if (<?php echo \Illuminate\Support\Js::from($scriptFileUrl)->toHtml() ?>) {
            syncScriptFile(
                <?php echo \Illuminate\Support\Js::from($scriptFileUrl)->toHtml() ?>,
                <?php echo \Illuminate\Support\Js::from($minute->script_file_path ? basename($minute->script_file_path) : null)->toHtml() ?>,
                <?php echo \Illuminate\Support\Js::from($scriptFileDownloadUrl)->toHtml() ?>
            );
        }
        if (<?php echo \Illuminate\Support\Js::from($finalAudioUrl)->toHtml() ?>) {
            syncFinalAudio(
                <?php echo \Illuminate\Support\Js::from($finalAudioUrl)->toHtml() ?>,
                <?php echo \Illuminate\Support\Js::from($minute->final_audio_path ? basename($minute->final_audio_path) : null)->toHtml() ?>,
                <?php echo \Illuminate\Support\Js::from($finalAudioDownloadUrl)->toHtml() ?>
            );
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\minutes\preview.blade.php ENDPATH**/ ?>