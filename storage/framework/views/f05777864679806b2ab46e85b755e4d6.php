...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4" x-data="{ showAddPanel: false, showRequestPanel: <?php echo \Illuminate\Support\Js::from($requestPanelHasErrors)->toHtml() ?>, activeTab: <?php echo \Illuminate\Support\Js::from($requestPanelHasErrors ? 'requests' : 'stock')->toHtml() ?> }" @keydown.escape.window="showAddPanel = false; showRequestPanel = false">
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        ...
        <?php echo $__env->make('corporate.stock-transfer-book.partials.section-tabs', ['currentStockTransferTab' => 'certificates'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="overflow-auto">
                <table class="min-w-full">
                    ...
                    <tbody id="certificate-stock-body" class="text-sm text-gray-900">
                        <?php $__empty_1 = true; $__currentLoopData = $certificateStocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-search-row class="border-b border-gray-100 hover:bg-gray-50 cursor-pointer" onclick="window.location='<?php echo e(route('stock-transfer-book.certificates.show', $certificate)); ?>'">
                                <td class="px-4 py-3"><?php echo e($certificate->certificate_type ?: 'COS'); ?></td>
                                <td class="px-4 py-3"><?php echo e($certificate->stock_number); ?></td>
                                <td class="px-4 py-3"><?php echo e($certificate->stockholder_name); ?></td>
                                <td class="px-4 py-3"><?php echo e(optional($certificate->date_issued)->format('M d, Y')); ?></td>
                                <td class="px-4 py-3"><?php echo e($certificate->number); ?></td>
                                <td class="px-4 py-3"><?php echo e($certificate->amount); ?></td>
                                <td class="px-4 py-3"><?php echo e(ucfirst($certificate->status ?: 'active')); ?></td>
                            </tr>
            ...
            <div class="overflow-auto">
                <table class="min-w-full">
                    ...
                    <tbody id="certificate-voucher-body" class="text-sm text-gray-900">
                        <?php $__empty_1 = true; $__currentLoopData = $certificateVouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voucher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-search-row class="border-b border-gray-100 hover:bg-gray-50">
                                <td class="px-4 py-3"><?php echo e($voucher->certificate_type ?: 'COS'); ?></td>
                                <td class="px-4 py-3"><?php echo e($voucher->sourceCertificate?->stock_number ?: $voucher->stock_number); ?></td>
                                <td class="px-4 py-3"><?php echo e($voucher->issued_to ?: $voucher->stockholder_name); ?></td>
                                <td class="px-4 py-3"><?php echo e($voucher->issued_to_type ?: 'Stockholder'); ?></td>
                                <td class="px-4 py-3"><?php echo e(optional($voucher->released_at)->format('M d, Y h:i A') ?: optional($voucher->date_issued)->format('M d, Y')); ?></td>
                                <td class="px-4 py-3"><?php echo e(ucfirst($voucher->status ?: 'released')); ?></td>
                                <td class="px-4 py-3">
                                    <a href="<?php echo e(route('stock-transfer-book.certificates.show', $voucher)); ?>" class="text-blue-600 hover:text-blue-700 text-xs font-medium">View</a>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr data-empty-row>
            ...
            <div class="overflow-auto">
                <table class="min-w-full">
                    ...
                    <tbody id="certificate-request-body" class="text-sm text-gray-900">
                        <?php $__empty_1 = true; $__currentLoopData = $issuanceRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requestRecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-search-row class="border-b border-gray-100 hover:bg-gray-50">
                                <td class="px-4 py-3"><?php echo e($requestRecord->reference_no); ?></td>
                                <td class="px-4 py-3"><?php echo e(optional($requestRecord->requested_at)->format('M d, Y h:i A')); ?></td>
                                <td class="px-4 py-3"><?php echo e($requestRecord->request_type); ?></td>
                                <td class="px-4 py-3"><?php echo e($requestRecord->issuance_type); ?></td>
                                <td class="px-4 py-3"><?php echo e($requestRecord->requester); ?></td>
                                <td class="px-4 py-3"><?php echo e($requestRecord->received_by); ?></td>
                                <td class="px-4 py-3"><?php echo e(ucfirst($requestRecord->status)); ?></td>
                                <td class="px-4 py-3">
                                    <a href="<?php echo e(route('stock-transfer-book.certificates.requests.show', $requestRecord)); ?>" class="text-blue-600 hover:text-blue-700 text-xs font-medium">Preview</a>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr data-empty-row>
    ...
    <div x-cloak>
        ...
        <div x-show="showAddPanel" data-add-panel class="fixed inset-y-0 right-0 w-full max-w-xl bg-white shadow-2xl z-50 flex flex-col" x-transition @click.stop>
            ...
            <form method="POST" action="<?php echo e(route('stock-transfer-book.certificates.store')); ?>" enctype="multipart/form-data" class="p-6 overflow-y-auto space-y-4">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="uploaded_by" value="<?php echo e($currentUser); ?>" readonly class="mt-1 block w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm text-gray-600">
                    </div>
                    <div>
                        ...
                        <?php if($stockNumberDirectory->isNotEmpty()): ?>
                            <div class="mt-2 rounded-lg border border-gray-200 bg-gray-50 p-2">
                                ...
                                <div class="max-h-44 space-y-2 overflow-y-auto pr-1">
                                    <?php $__currentLoopData = $stockNumberDirectory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stockOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button
                                            type="button"
                                            ...
                                            data-stock-number-option="<?php echo e($stockOption->stock_number); ?>"
                                            @click.prevent="$refs.certificateStockNumber.value = '<?php echo e($stockOption->stock_number); ?>'; window.syncCertificateStockFields($refs.certificateStockNumber)"
                                        >
                                            <div class="min-w-0">
                                                <div class="text-sm font-semibold text-gray-900"><?php echo e($stockOption->stock_number); ?></div>
                                                <div class="truncate text-xs text-gray-600"><?php echo e($stockOption->holder_name ?: 'No stockholder linked yet'); ?></div>
                                            </div>
                                            <div class="shrink-0 text-right">
                                                <div class="text-[11px] font-medium text-gray-700"><?php echo e($stockOption->source); ?></div>
                                                <div class="text-[11px] <?php echo e($stockOption->is_recommended ? 'text-green-600' : 'text-amber-600'); ?>"><?php echo e($stockOption->status_label); ?></div>
                                            </div>
                                        </button>
    ...
    <div x-cloak>
        ...
        <div x-show="showRequestPanel" data-request-panel class="fixed inset-y-0 right-0 w-full max-w-xl bg-white shadow-2xl z-50 flex flex-col" x-transition @click.stop>
            ...
            <form method="POST" action="<?php echo e(route('stock-transfer-book.certificates.requests.store')); ?>" enctype="multipart/form-data" class="p-6 overflow-y-auto space-y-4">
                <?php echo csrf_field(); ?>
                <?php if($requestPanelHasErrors): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="reference_no" value="<?php echo e(old('reference_no', $nextIssuanceRequestReference ?? 'REQ-0001')); ?>" data-default-field="reference_no" readonly class="mt-1 block w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm text-gray-600">
                    </div>
                    <div>
                        <label class="text-xs text-gray-600">Date and Time</label>
                        <input type="datetime-local" name="requested_at" value="<?php echo e(old('requested_at', $defaultRequestedAt ?? now()->format('Y-m-d\\TH:i'))); ?>" data-default-field="now" readonly class="mt-1 block w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm text-gray-600">
                    </div>
                    <div>
                        ...
                        <select name="request_type" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm">
                            <?php $__currentLoopData = ['New COS', 'Loss COS', 'Damage COS', 'Digital Copy of COS', 'Certified True Copy of CV']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requestTypeOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($requestTypeOption); ?>" <?php if(old('request_type') === $requestTypeOption): echo 'selected'; endif; ?>><?php echo e($requestTypeOption); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="issuance_type" data-issuance-type class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm">
                            <option value="COS" <?php if(old('issuance_type', 'COS') === 'COS'): echo 'selected'; endif; ?>>COS</option>
                            <option value="CV" <?php if(old('issuance_type') === 'CV'): echo 'selected'; endif; ?>>CV</option>
                        </select>
                    </div>
                    <div class="md:col-span-2">
                        <label class="text-xs text-gray-600">Requester</label>
                        <input type="text" name="requester" list="index-shareholders" value="<?php echo e(old('requester')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Choose from index or enter manually">
                    </div>
                    <div>
                        <label class="text-xs text-gray-600">Received By</label>
                        <input type="text" name="received_by" value="<?php echo e(old('received_by', $currentUser)); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm">
                    </div>
                    <div>
                        <label class="text-xs text-gray-600">Issued By</label>
                        <input type="text" name="issued_by" value="<?php echo e(old('issued_by', $currentUser)); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <select name="certificate_id" data-certificate-stock class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm">
                            ...
                            <?php $__currentLoopData = $certificateStocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($certificate->id); ?>" data-type="<?php echo e($certificate->certificate_type ?: 'COS'); ?>" <?php if((string) old('certificate_id') === (string) $certificate->id): echo 'selected'; endif; ?>>
                                    <?php echo e($certificate->certificate_type ?: 'COS'); ?> - <?php echo e($certificate->stock_number); ?> - <?php echo e($certificate->stockholder_name); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" rows="3" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Optional request notes"><?php echo e(old('notes')); ?></textarea>
                    </div>
                    <div class="md:col-span-2">
...
<datalist id="certificate-stock-numbers">
    <?php $__currentLoopData = $stockNumberOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stockNumberOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($stockNumberOption); ?>"></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>
...
<script>
    window.syncCertificateStockFields = async function (stockInput) {
        ...
        try {
            const res = await fetch(`<?php echo e(route('stock-transfer-book.lookup')); ?>?key=${encodeURIComponent(key)}`);
            if (!res.ok) return;
    ...
    (function () {
        ...
        const currentUser = <?php echo json_encode($currentUser, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\stock-transfer-book\certificates.blade.php ENDPATH**/ ?>