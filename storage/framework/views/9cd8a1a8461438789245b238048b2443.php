        ...
        <section class="bg-gray-50 p-4 min-h-[760px]">
            <div class="rounded-md border border-gray-200 bg-white overflow-hidden shadow-sm">
                <div class="border-b border-gray-100 px-4 py-4">
                    ...
                    <?php if(session('products_success')): ?>
                        <div class="mt-4 rounded-md border border-green-200 bg-green-50 px-4 py-3 text-sm font-medium text-green-700">
                            <?php echo e(session('products_success')); ?>

                        </div>
                    <?php endif; ?>

                    <form method="GET" action="<?php echo e(route('company.products', $company->id)); ?>" class="mt-4 grid grid-cols-1 gap-2 lg:grid-cols-12">
                        ...
                        <div class="lg:col-span-2">
                            <select name="category" class="w-full h-10 rounded border border-gray-200 bg-white px-3 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400">
                                ...
                                <?php $__currentLoopData = $categoryOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($categoryOption); ?>" <?php if($category === $categoryOption): echo 'selected'; endif; ?>><?php echo e($categoryOption); ?></option>
                        ...
                        <div class="lg:col-span-2">
                            <select name="status" class="w-full h-10 rounded border border-gray-200 bg-white px-3 text-sm text-gray-700 outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400">
                                <option value="all" <?php if($status === 'all'): echo 'selected'; endif; ?>>Status: All</option>
                                <option value="Active" <?php if($status === 'Active'): echo 'selected'; endif; ?>>Status: Active</option>
                                <option value="Inactive" <?php if($status === 'Inactive'): echo 'selected'; endif; ?>>Status: Inactive</option>
                                <option value="Draft" <?php if($status === 'Draft'): echo 'selected'; endif; ?>>Status: Draft</option>
                            </select>
                        </div>
                        ...
                        <div class="lg:col-span-3 flex items-center gap-2">
                            ...
                            <?php if($search !== '' || $status !== 'all' || $category !== 'all'): ?>
                                <a href="<?php echo e(route('company.products', $company->id)); ?>" class="h-10 flex-1 rounded border border-gray-200 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 inline-flex items-center justify-center">
                                    Clear
                                </a>
                            <?php endif; ?>
                        </div>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-4 py-3">
                                                ...
                                                <?php if(! empty($product['description'])): ?>
                                                    <div class="mt-1 text-xs text-gray-500"><?php echo e($product['description']); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td class="px-4 py-3"><?php echo e($product['sku']); ?></td>
                                            <td class="px-4 py-3"><?php echo e($product['category']); ?></td>
                                            <td class="px-4 py-3 font-medium text-gray-900">P<?php echo e(number_format((float) $product['price'], 2)); ?></td>
                                            <td class="px-4 py-3"><?php echo e($product['pricing_type']); ?></td>
                                            <td class="px-4 py-3">
                                                ...
                                                <span class="inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-medium <?php echo e($statusClasses); ?>"><?php echo e($product['status']); ?></span>
                                            </td>
                                            <td class="px-4 py-3"><?php echo e($product['linked_at'] ?? '-'); ?></td>
                                            <td class="px-4 py-3">
                                                <div class="flex items-center justify-end gap-2">
                                                    <a href="<?php echo e(route('company.products.show', [$company->id, $product['id']])); ?>" class="inline-flex h-8 items-center rounded-full border border-gray-200 px-3 text-xs font-medium text-gray-700 hover:bg-gray-50">
                                                        View
                                                    </a>
                                                    <button type="button" class="inline-flex h-8 items-center rounded-full border border-gray-200 px-3 text-xs font-medium text-gray-700 hover:bg-gray-50" data-product-edit='<?php echo json_encode($product, 15, 512) ?>'>
                                                        Edit
                                                    </button>
                                                    <form method="POST" action="<?php echo e(route('company.products.unlink', [$company->id, $product['id']])); ?>" onsubmit="return confirm('Unlink this product from the current company?');">
                                                        <?php echo csrf_field(); ?>
                                        ...
                                        <tr>
                                            <td colspan="8" class="px-4 py-12">
                                                <div class="flex flex-col items-center justify-center text-center">
                                                    ...
                                                    <p class="mt-1 max-w-md text-sm text-gray-500">Link an existing product or create a new one and automatically associate it with <?php echo e($company->company_name); ?>.</p>
                ...
                <div class="border-t border-gray-100 px-4 py-3 flex flex-wrap items-center justify-end gap-3 text-sm text-gray-500">
                    <span><?php echo e($products->count()); ?> <?php echo e(\Illuminate\Support\Str::plural('linked product', $products->count())); ?></span>
                </div>
            </div>
        </section>
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.slide-over','data' => ['id' => 'linkProductModal','width' => 'sm:max-w-[680px] lg:max-w-[820px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'linkProductModal','width' => 'sm:max-w-[680px] lg:max-w-[820px]']); ?>
    <div class="border-b border-gray-100 px-4 py-4 sm:px-6">
        <div class="flex items-start justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Select products to link to <?php echo e($company->company_name); ?>. Already linked products are disabled.</p>
            </div>
    ...
    <form method="POST" action="<?php echo e(route('company.products.link', $company->id)); ?>" class="flex min-h-0 flex-1 flex-col">
        <?php echo csrf_field(); ?>
...
<?php if (isset($component)) { $__componentOriginal6ef8dd008d82ca426db4c565227b1725 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ef8dd008d82ca426db4c565227b1725 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.slide-over','data' => ['id' => 'productModal','width' => 'sm:max-w-[640px] lg:max-w-[760px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('slide-over'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'productModal','width' => 'sm:max-w-[640px] lg:max-w-[760px]']); ?>
    <div class="border-b border-gray-100 px-4 py-4 sm:px-6">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 id="productModalTitle" class="text-lg font-semibold text-gray-900">New Product</h2>
                <p class="mt-1 text-sm text-gray-500">Products created here are automatically linked to <?php echo e($company->company_name); ?>.</p>
            </div>
    ...
    <form id="productForm" method="POST" action="<?php echo e(route('company.products.store', $company->id)); ?>" class="flex min-h-0 flex-1 flex-col">
        <?php echo csrf_field(); ?>
        ...
        <div class="flex-1 overflow-y-auto px-4 py-4 sm:px-6">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <input id="product_name" name="name" type="text" value="<?php echo e(old('name')); ?>" class="h-9 w-full rounded border border-gray-200 px-4 text-sm text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="product_sku" name="sku" type="text" value="<?php echo e(old('sku')); ?>" class="h-9 w-full rounded border border-gray-200 px-4 text-sm text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100">
                    <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="product_category" name="category" type="text" value="<?php echo e(old('category')); ?>" class="h-9 w-full rounded border border-gray-200 px-4 text-sm text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="product_price" name="price" type="number" step="0.01" min="0" value="<?php echo e(old('price')); ?>" class="h-9 w-full rounded border border-gray-200 px-4 text-sm text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select id="product_pricing_type" name="pricing_type" class="h-9 w-full rounded border border-gray-200 bg-white px-4 text-sm text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100">
                        <?php $__currentLoopData = ['Recurring', 'One-Time', 'Milestone']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pricingType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($pricingType); ?>" <?php if(old('pricing_type', 'Recurring') === $pricingType): echo 'selected'; endif; ?>><?php echo e($pricingType); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select id="product_status" name="status" class="h-9 w-full rounded border border-gray-200 bg-white px-4 text-sm text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100">
                        <?php $__currentLoopData = ['Active', 'Inactive', 'Draft']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($productStatus); ?>" <?php if(old('status', 'Active') === $productStatus): echo 'selected'; endif; ?>><?php echo e($productStatus); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="product_description" name="description" rows="3" class="w-full rounded border border-gray-200 px-4 py-3 text-sm text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="product_notes" name="notes" rows="3" class="w-full rounded border border-gray-200 px-4 py-3 text-sm text-gray-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"><?php echo e(old('notes')); ?></textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const productCatalog = <?php echo json_encode($productCatalog, 15, 512) ?>;
        const linkedProducts = <?php echo json_encode($products->values(), 15, 512) ?>;
        ...
        const productShowUrlTemplate = <?php echo json_encode(route('company.products.update', [$company->id, '__PRODUCT__'])) ?>;
        ...
        const resetProductForm = () => {
            productForm.reset();
            productForm.action = <?php echo json_encode(route('company.products.store', $company->id), 512) ?>;
        ...
        <?php if($errors->has('name') || $errors->has('sku') || $errors->has('category') || $errors->has('price') || $errors->has('pricing_type') || $errors->has('status') || $errors->has('description') || $errors->has('notes')): ?>
            resetProductForm();
            openModal(productModal);
        <?php endif; ?>
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\company\products.blade.php ENDPATH**/ ?>