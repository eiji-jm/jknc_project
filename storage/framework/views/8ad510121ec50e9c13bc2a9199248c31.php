    ...
    <div class="grid grid-cols-3 gap-6">
            ...
            <div x-show="fileTab === 'draft'">
                ...
                <?php else: ?>
                    <div class="w-full h-[700px] border rounded flex items-center justify-center bg-gray-50 text-gray-400 text-sm">
                        No draft file attached for this SEC-AOI record.
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="bg-white border rounded-lg p-6 space-y-4">
            ...
            <div class="flex justify-between gap-4">
                ...
                <span class="font-medium text-right"><?php echo e($record->corporation_name); ?></span>
            </div>
            ...
            <div class="flex justify-between gap-4">
                ...
                <span class="text-right"><?php echo e($record->principal_address); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">Par Value</span>
                <span class="text-right"><?php echo e($record->par_value); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">Authorized Capital</span>
                <span class="text-right"><?php echo e($record->authorized_capital_stock); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">Directors</span>
                <span class="text-right"><?php echo e($record->directors); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">Formation</span>
                <span class="text-right"><?php echo e($record->type_of_formation); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">AOI Version</span>
                <span class="text-right"><?php echo e($record->aoi_version); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">Version Type</span>
                <span class="text-right"><?php echo e($record->aoi_type); ?></span>
            </div>

            <div class="flex justify-between gap-4">
                <span class="text-gray-500">Uploaded By</span>
                <span class="text-right"><?php echo e($record->uploaded_by); ?></span>
            </div>
            ...
            <div class="flex justify-between gap-4">
                ...
                <span class="text-right"><?php echo e($record->workflow_status); ?></span>
            </div>
            ...
            <div class="pt-4 border-t border-gray-100">
                ...
                <?php if($canEditRecord): ?>
                    <form x-show="editDraft || !<?php echo e($draftUrl ? 'true' : 'false'); ?>" x-cloak
                          action="<?php echo e(route('corporate.sec_aoi.upload.draft', $record->id)); ?>"
                          method="POST"
            ...
            <div class="pt-4 border-t border-gray-100">
                ...
                <?php if($canEditRecord): ?>
                    <form x-show="editNotary || !<?php echo e($notaryUrl ? 'true' : 'false'); ?>" x-cloak
                          action="<?php echo e(route('corporate.sec_aoi.upload.notary', $record->id)); ?>"
                          method="POST"
                          enctype="multipart/form-data"
                          class="space-y-3">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\sec-aoi-preview.blade.php ENDPATH**/ ?>