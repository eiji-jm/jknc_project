        ...
        <form method="GET" class="flex flex-col md:flex-row gap-3 md:items-center md:justify-between">
            ...
            <div class="flex gap-3">
                ...
                >
                    ...
                    <option value="image" <?php echo e(request('type') === 'image' ? 'selected' : ''); ?>>Images</option>
                ...
                <a
                    href="<?php echo e(route('townhall.attachments')); ?>"
    ...
    <div class="bg-white border border-gray-200 rounded-xl flex-1 flex flex-col overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            <div class="text-sm text-gray-600">
                Total Files:
                <span class="font-semibold text-gray-800"><?php echo e($communications->total()); ?></span>
            </div>
        </div>

        <div class="p-5 overflow-auto flex-1">
            <?php if($communications->count()): ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5">
                    <?php $__currentLoopData = $communications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-md transition">
                            ...
                            <div class="h-44 bg-gray-50 border-b border-gray-200 flex items-center justify-center overflow-hidden">
                                <?php if(in_array($ext, ['jpg','jpeg','png','gif','webp'])): ?>
                                    <img
                                        src="<?php echo e(asset('storage/' . $item->attachment)); ?>"
                                        alt="<?php echo e($item->subject); ?>"
                                        class="w-full h-full object-cover"
                                    >
                                <?php elseif($ext === 'pdf'): ?>
                                    <div class="flex flex-col items-center justify-center text-red-600">
                                        <i class="fas <?php echo e($icon); ?> text-5xl mb-2"></i>
                            ...
                            <div class="p-4">
                                <div class="flex items-start justify-between gap-2 mb-3">
                                    <div class="min-w-0">
                                        <p class="text-sm font-semibold text-gray-800 truncate">
                                            <?php echo e($item->subject ?: 'Untitled Attachment'); ?>
                                    ...
                                    <span class="shrink-0 px-2 py-1 rounded-full text-[11px] font-medium <?php echo e($badge); ?>">
                                        <?php echo e($type); ?>
                                ...
                                <div class="space-y-1 text-xs text-gray-500 mb-4">
                                    <p><span class="font-medium text-gray-700">From:</span> <?php echo e($item->from_name); ?></p>
                                    <p><span class="font-medium text-gray-700">Department:</span> <?php echo e($item->department_stakeholder); ?></p>
                                    <p><span class="font-medium text-gray-700">Date:</span> <?php echo e($item->communication_date); ?></p>
                                </div>

                                
                                <div class="flex flex-wrap gap-2">
                                    <a
                                        href="<?php echo e(asset('storage/' . $item->attachment)); ?>"
                                        target="_blank"
                                    ...
                                    <a
                                        href="<?php echo e(route('townhall.show', $item->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views/townhall/attachments.blade.php ENDPATH**/ ?>