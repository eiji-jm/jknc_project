    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="flex items-center gap-3 px-4 py-4 border-b border-gray-100">
            ...
            <div>
                ...
                <div class="text-xs text-gray-500">TIN <?php echo e($tax->tin ?? '-'); ?></div>
            </div>
            ...
            <form method="POST" action="<?php echo e($deleteRoute); ?>" onsubmit="return confirm('Delete this BIR & Tax entry?');">
                <?php echo csrf_field(); ?>
            ...
            <div class="lg:col-span-2 space-y-4">
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">TIN</span><div class="font-medium text-gray-900"><?php echo e($tax->tin ?? '-'); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Tax Payer</span><div class="font-medium text-gray-900"><?php echo e($tax->tax_payer ?? '-'); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Registering Office</span><div class="font-medium text-gray-900"><?php echo e($tax->registering_office ?? '-'); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Registered Address</span><div class="font-medium text-gray-900"><?php echo e($tax->registered_address ?? '-'); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Form Type</span><div class="font-medium text-gray-900"><?php echo e($tax->form_type ?? '-'); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Deadline</span><div class="font-medium text-gray-900"><?php echo e(optional($tax->due_date)->format('M d, Y') ?? '-'); ?></div></div>
                        <div><span class="text-xs text-gray-600 uppercase tracking-wide">Status</span><div class="font-medium text-gray-900"><?php echo e($tax->display_status); ?></div></div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-emerald-200 rounded-xl p-4">
                    ...
                    <form method="POST" action="<?php echo e($updateRoute); ?>" enctype="multipart/form-data" class="mt-4 space-y-3">
                        ...
                        <button type="submit" class="w-full rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
                            <?php echo e($tax->approved_document_path ? 'Upload Approved Revision' : 'Upload Approved File'); ?>
                ...
                <div class="bg-white border border-amber-200 rounded-xl p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('bir-tax.notes.store', $tax)); ?>" class="mt-4 space-y-3">
                        <?php echo csrf_field(); ?>
                        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\bir-tax\preview.blade.php ENDPATH**/ ?>