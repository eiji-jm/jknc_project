...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4" x-data="resolutionForm(<?php echo e(Js::from($minuteOptions)); ?>, <?php echo \Illuminate\Support\Js::from($currentUser)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from(route('corporate-document-defaults'))->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($nextResolutionNumber ?? '')->toHtml() ?>)" @keydown.escape.window="showAddPanel = false">
            ...
            <div class="overflow-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="text-sm text-gray-900">
                        <?php $__empty_1 = true; $__currentLoopData = $resolutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resolution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('resolutions.preview', $resolution)); ?>'">
                                <td class="px-4 py-3 font-medium"><?php echo e($resolution->resolution_no); ?></td>
                                <td class="px-4 py-3">
                                    <div><?php echo e($resolution->notice_ref); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($resolution->notice?->governing_body); ?></div>
                                </td>
                                <td class="px-4 py-3">
                                    <div><?php echo e($resolution->board_resolution); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($resolution->resolution_body), 80)); ?></div>
                                </td>
                                <td class="px-4 py-3">
                                    <div><?php echo e(optional($resolution->date_of_meeting)->format('M d, Y')); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($resolution->location); ?></div>
                                </td>
                                <td class="px-4 py-3 text-xs">
                                    <span class="inline-flex rounded-full px-2 py-1 font-semibold <?php echo e($resolution->draft_file_path ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600'); ?>">Draft <?php echo e($resolution->draft_file_path ? 'uploaded' : 'generated'); ?></span>
                                    <span class="inline-flex rounded-full px-2 py-1 font-semibold <?php echo e($resolution->notarized_file_path ? 'bg-blue-100 text-blue-700' : 'bg-amber-100 text-amber-700'); ?>">Original <?php echo e($resolution->notarized_file_path ? 'ready' : 'pending'); ?></span>
                                </td>
                                <td class="px-4 py-3"><?php echo e($resolution->secretaryCertificates->count()); ?></td>
                            </tr>
    ...
    <div x-cloak>
        ...
        >
            ...
            <form method="POST" action="<?php echo e(route('resolutions.store')); ?>" enctype="multipart/form-data" class="flex-1 overflow-y-auto p-6 space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="resolution_no" x-ref="resolutionNo" value="<?php echo e($nextResolutionNumber ?? ''); ?>" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="RES-2026-001">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="uploaded_by" x-ref="uploadedBy" value="<?php echo e($currentUser); ?>" data-default-field="current_user" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Uploader">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="notary_series_no" class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" value="<?php echo e(now()->year); ?>">
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\resolutions\index.blade.php ENDPATH**/ ?>