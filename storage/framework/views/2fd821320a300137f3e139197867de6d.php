    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="<?php echo e(route('stock-transfer-book.ledger')); ?>" class="p-6 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-all group">
                ...
                <a href="<?php echo e(route('stock-transfer-book.journal')); ?>" class="p-6 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-all group">
                    <div class="flex items-start gap-3">
                ...
                <a href="<?php echo e(route('stock-transfer-book.index')); ?>" class="p-6 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-all group">
                    <div class="flex items-start gap-3">
                ...
                <a href="<?php echo e(route('stock-transfer-book.installment')); ?>" class="p-6 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-all group">
                    <div class="flex items-start gap-3">
                ...
                <a href="<?php echo e(route('stock-transfer-book.certificates')); ?>" class="p-6 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-all group">
                    <div class="flex items-start gap-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\stock-transfer-book\index.blade.php ENDPATH**/ ?>