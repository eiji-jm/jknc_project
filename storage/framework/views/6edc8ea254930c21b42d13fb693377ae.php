...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-4"
    ...
    <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden">
        ...
        <div class="flex items-center gap-3 px-4 py-3 border-b border-gray-100 bg-white">
            <?php echo $__env->make('corporate.partials.section-ribbon', ['activeTab' => 'gis', 'topButtonLabel' => 'SEC-GIS'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views/corporate/gis.blade.php ENDPATH**/ ?>