...
<div class="px-6 py-6 lg:px-8">
    ...
    <form id="contactsSearchForm" method="GET" action="<?php echo e(route('contacts.index')); ?>" class="mb-4 flex flex-wrap items-center gap-3">
        ...
        >
            <option value="All" <?php echo e($kycFilter === 'All' ? 'selected' : ''); ?>>All</option>
            <?php $__currentLoopData = $kycStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($status); ?>" <?php echo e($kycFilter === $status ? 'selected' : ''); ?>><?php echo e($status); ?></option>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="text-gray-700">
                            <td class="px-3 py-3"><input type="checkbox" value="<?php echo e($contact->id); ?>" class="row-checkbox h-4 w-4 rounded border-gray-300"></td>
                            <td class="px-3 py-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="<?php echo e(route('contacts.show', $contact)); ?>" class="font-medium text-gray-900 hover:text-blue-700">
                                        <?php echo $highlightMatch(trim($contact->first_name.' '.$contact->last_name)); ?>

                                    </a>
                                </div>
                            </td>
                            <td class="px-3 py-3"><?php echo e($contact->company_name ?: '-'); ?></td>
                            <td class="px-3 py-3"><?php echo e($contact->email ?: '-'); ?></td>
                            <td class="px-3 py-3"><?php echo e($contact->phone ?: '-'); ?></td>
                            <td class="px-3 py-3">
                                <span class="inline-flex rounded-full px-2 py-0.5 text-xs font-medium <?php echo e($statusPillClasses[$contact->kyc_status] ?? $statusPillClasses['Not Submitted']); ?>">
                                    <?php echo e($contact->kyc_status); ?>

                                </span>
                            </td>
                            <td class="px-3 py-3"><?php echo e($contact->owner_name ?: '-'); ?></td>
                            <td class="px-3 py-3"><?php echo e($contact->last_activity_at?->diffForHumans() ?? 'No activity'); ?></td>
                            <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e(9 + count($customFields)); ?>" class="px-3 py-10 text-center text-sm text-gray-500">No contacts found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <div class="mt-4 flex flex-wrap items-center gap-4 text-sm text-gray-700">
        <span>Total Contacts: <?php echo e($contacts->total()); ?></span>
        <span>Verified: <span class="text-green-600"><?php echo e($statusCounts['Verified']); ?></span></span>
        <span>Pending: <span class="text-amber-600"><?php echo e($statusCounts['Pending Verification']); ?></span></span>
        <span>Not Submitted: <?php echo e($statusCounts['Not Submitted']); ?></span>
        <span>Rejected: <span class="text-red-600"><?php echo e($statusCounts['Rejected']); ?></span></span>
        <div class="ml-auto flex items-center gap-2 text-sm text-gray-600">
            <a href="<?php echo e($contacts->onFirstPage() ? '#' : $contacts->previousPageUrl()); ?>" class="rounded-md border border-gray-200 px-3 py-1 <?php echo e($contacts->onFirstPage() ? 'pointer-events-none opacity-40' : 'hover:bg-gray-50'); ?>">Prev</a>
            <?php $__currentLoopData = $contacts->getUrlRange(1, $contacts->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($url); ?>" class="rounded-md border px-3 py-1 <?php echo e($contacts->currentPage() === $page ? 'border-blue-600 bg-blue-600 text-white' : 'border-gray-200 hover:bg-gray-50'); ?>"><?php echo e($page); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e($contacts->hasMorePages() ? $contacts->nextPageUrl() : '#'); ?>" class="rounded-md border border-gray-200 px-3 py-1 <?php echo e($contacts->hasMorePages() ? 'hover:bg-gray-50' : 'pointer-events-none opacity-40'); ?>">Next</a>
        </div>
    </div>
</div>

<?php echo $__env->make('contacts.partials.create-modal', [
    'owners' => $owners,
...
<div id="deleteSelectedModal" class="fixed inset-0 z-[70] hidden" aria-hidden="true">
    ...
    <div class="absolute inset-0 flex items-center justify-center px-4">
        <div class="w-full max-w-md rounded-2xl bg-white shadow-2xl">
            ...
            <form id="bulkDeleteForm" method="POST" action="<?php echo e(route('contacts.bulk-delete')); ?>">
                <?php echo csrf_field(); ?>
...
<div id="assignOwnerModal" class="fixed inset-0 z-[70] hidden" aria-hidden="true">
    ...
    <div class="absolute inset-y-0 right-0 flex w-full justify-end overflow-hidden pointer-events-none">
        <div id="assignOwnerPanel" class="pointer-events-auto flex h-full w-full max-w-[620px] translate-x-full flex-col border-l border-gray-200 bg-white shadow-2xl transition-transform duration-300 ease-out sm:max-w-[520px]">
            ...
            <form id="assignOwnerForm" method="POST" action="<?php echo e(route('contacts.assign-owner')); ?>" class="flex min-h-0 flex-1 flex-col">
                <?php echo csrf_field(); ?>
                ...
                <div class="min-h-0 flex-1 overflow-y-auto px-6 py-6 sm:px-8">
                        ...
                        <?php $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            >
                                <span class="flex h-7 w-7 items-center justify-center rounded-full bg-blue-100 text-[10px] font-semibold text-blue-700">
                                    <?php echo e($assignOwnerInitials); ?>
                    ...
                    <?php if($errors->has('assign_owner_id') || $errors->has('selected_contacts')): ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const oldSelectedContacts = <?php echo json_encode(old('selected_contacts', []), 512) ?>;
    ...
    <?php if($errors->any()): ?>
        ...
        <?php elseif($errors->has('assign_owner_id') || $errors->has('selected_contacts')): ?>
            openAssignOwnerModalFromIds(oldSelectedContacts);
        <?php else: ?>
            openModal();
        <?php endif; ?>
    <?php elseif($shouldOpenCreateModal): ?>
        openModal();
    <?php endif; ?>
});
</script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\contacts\index.blade.php ENDPATH**/ ?>