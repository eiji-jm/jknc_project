...
<div class="bg-white border border-gray-100 rounded-2xl overflow-hidden">
    ...
    <div class="flex items-center gap-3 px-4 py-3 border-b border-gray-100 bg-white">
        <?php echo $__env->make('corporate.partials.section-ribbon', ['activeTab' => 'bylaws', 'topButtonLabel' => 'SEC-BYLAWS'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr
                                ...
                                "
                                data-url="<?php echo e(route('corporate.bylaws.show', $row->id)); ?>"
                                onclick="window.location.href=this.dataset.url"
                                class="border-b border-gray-200 hover:bg-gray-50 cursor-pointer">

                                <td class="px-2 py-2"><?php echo e($row->date_upload); ?></td>
                                <td class="px-2 py-2 font-semibold text-gray-800"><?php echo e($row->uploaded_by); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->company_reg_no); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->corporation_name); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->type_of_formation); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->aoi_version); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->aoi_type); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->aoi_date); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->regular_asm); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->asm_notice); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->regular_bodm); ?></td>
                                <td class="px-2 py-2"><?php echo e($row->bodm_notice); ?></td>
                                ...
                                <td class="px-2 py-2 text-blue-600 font-medium">
                                    <div class="flex flex-col items-start gap-2">
                                        ...
                                        <?php if($workflow === 'Uploaded' || $workflow === 'Reverted'): ?>
                                            <?php if($canSubmit): ?>
                                                <form action="<?php echo e(route('corporate.bylaws.submit', $row->id)); ?>"
                                                      method="POST"
...
<form action="<?php echo e(route('corporate.bylaws.store')); ?>" method="POST" enctype="multipart/form-data" class="h-full flex flex-col">
<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\bylaws.blade.php ENDPATH**/ ?>