                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3 font-medium">
                                    <a href="<?php echo e(route('contacts.show', $contact)); ?>" class="text-gray-900 hover:underline">
                                        <?php echo e($contact->name); ?>

                                    </a>
                                </td>
                                <td class="px-4 py-3"><?php echo e($contact->email); ?></td>
                                <td class="px-4 py-3"><?php echo e($contact->nationality); ?></td>
                                <td class="px-4 py-3"><?php echo e($contact->address); ?></td>
                                <td class="px-4 py-3"><?php echo e($contact->tax_id); ?></td>
                            </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\School\OJT\JK&CDealsContacts\jknc_project\resources\views\corporate\contacts-list.blade.php ENDPATH**/ ?>