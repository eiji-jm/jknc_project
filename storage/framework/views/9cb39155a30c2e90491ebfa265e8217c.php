        ...
        <div class="flex-1 space-y-6 overflow-y-auto px-6 py-5">
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="scope_summary" rows="3" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm text-gray-900"><?php echo e(old('scope_summary')); ?></textarea>
                </div>
                <div class="md:col-span-2">
