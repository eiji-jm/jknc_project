...
<body>
    <div class="page">
        ...
        <div class="section">
            <p>has been granted a permit to operate the business described below:</p>
        ...
        <div class="section paragraph">
            <p>
                In accordance with existing laws, ordinances, and regulations of Cebu City,
                this permit is hereby issued subject to compliance with all applicable laws,
                rules, and regulations. Failure to comply shall be grounds for suspension
