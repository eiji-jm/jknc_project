...
<body>
    <div class="page">
        <div class="center">
            ...
            <p class="header-line">BUREAU OF FIRE PROTECTION</p>
        ...
        <div class="section">
            <p>has satisfactorily complied with the fire safety requirements prescribed by the Fire Code of the Philippines for the business establishment described below:</p>

            <table class="info-table">
                <tr>
                    <td class="label">NATURE OF BUSINESS:</td>
                    <td class="value">Business Consultant Firm</td>
                </tr>
                <tr>
                    <td class="label">LINE OF BUSINESS:</td>
                    <td class="value">
                        Business advisory, management consultancy, financial planning,
                        operations support, and strategic development services.
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="section paragraph">
            <p>
                This certificate is issued upon finding that the establishment has complied
                with the applicable fire safety provisions, rules, and regulations under
                existing laws. This shall remain valid unless suspended, revoked, or expired
                in accordance with governing fire safety regulations.
            </p>
        </div>
            ...
            <table class="signature-table">
                <tr>
                    <td>
                        ...
                        <div>Bureau of Fire Protection</div>
                    </td>
                    <td>
                        <div class="signature-line"></div>
