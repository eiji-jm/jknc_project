...
<body>
    <div class="page">
        <div class="center">
            ...
            <p class="header-line">BARANGAY BUSINESS PERMIT AND LICENSING OFFICE</p>
        ...
        <div class="section paragraph">
            <p>
                This is to certify further that the above-named business establishment has complied
                with the barangay requirements and is hereby granted permission to operate within
                the territorial jurisdiction of the barangay, subject to existing laws, ordinances,
