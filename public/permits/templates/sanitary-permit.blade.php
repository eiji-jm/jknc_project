...
<body>
    <div class="page">
        <div class="center">
            ...
            <p class="header-line">CITY HEALTH OFFICE</p>
        ...
        <div class="section">
            <p>This is to certify that the establishment described below has complied with the sanitary requirements prescribed by law:</p>
        ...
        <div class="section paragraph">
            <p>
                This permit is issued after inspection and verification that the premises,
                facilities, and operations of the establishment are maintained in a sanitary
                condition and are in compliance with the applicable health and sanitation rules
                and regulations.
            </p>
        </div>
